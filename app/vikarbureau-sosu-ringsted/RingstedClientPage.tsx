...
export default function RingstedClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Vikarbureau SOSU Ringsted - Professionelle SOSU-vikarer til plejehjem og hjemmepleje",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og professionelle vikarbureau SOSU Ringsted. Vi leverer erfarne SOSU-assistenter og SOSU-hjælpere til plejehjem, hjemmepleje, hospitaler og andre sundhedsinstitutioner i Ringsted Kommune.",
    },
    {
      src: "/vikarbureau-indoor.jpeg",
      alt: "SOSU-vikar der støtter ældre borger i Ringsted",
      title: "Specialiseret i sundhed og pleje",
      subtitle:
        "Vores SOSU-personale er uddannet til at håndtere komplekse plejesituationer med professionalisme og omsorg. Vi leverer både akut udrykning og planlagte vikarløsninger til alle typer sundhedsinstitutioner i Ringsted og omegn.",
    },
    {
      src: "/vikarbureau-outdoor.jpeg",
      alt: "SOSU-vikar i samtale med borger i park i Ringsted",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, hjemmepleje, hospitaler og andre sundhedsinstitutioner i Ringsted Kommune. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  const data = allCityInfo["koege-psykiatrisk-vikarbureau"]

  return (
    <div className="min-h-screen">
      {/* Enhanced Hero Section */}
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Ringsted & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et SOSU Vikarbureau i Ringsted?
              </h3>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <Badge className="bg-red-100 text-red-600 mb-6 text-sm px-4 py-2">SOSU Vikarbureau</Badge>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Vikarbureau SOSU Ringsted med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Hos <strong>Tryghedspersonale.dk</strong> er vi et erfarent og professionelt{" "}
                    <strong>vikarbureau SOSU Ringsted</strong>, der leverer kompetente og fleksible social- og
                    sundhedsassistenter (SOSU-assistenter) samt social- og sundhedshjælpere (SOSU-hjælpere).
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Ringsted er en aktiv kommune med plejecentre, hjemmeplejeordninger og sundhedstilbud. Derfor er det
                    afgørende at have adgang til <strong>kvalificerede vikarer</strong>, der kan træde til med kort
                    varsel – og som samtidig forstår vigtigheden af kontinuitet, faglighed og omsorg.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Hvad gør os til det rette valg?
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Erfarne SOSU-assistenter og SOSU-hjælpere</strong>
                          <p className="text-gray-700 text-sm">med dokumenteret uddannelse og praktisk erfaring</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Fleksibilitet</strong>
                          <p className="text-gray-700 text-sm">
                            Vi leverer både akut udrykning og planlagte vikarløsninger
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Lokalt kendskab</strong>
                          <p className="text-gray-700 text-sm">
                            Vores vikarer kender Ringsted og de kommunale arbejdsgange
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Menneskelighed i fokus</strong>
                          <p className="text-gray-700 text-sm">Vi prioriterer omsorg, nærvær og respekt for borgeren</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-700 mt-6">
                      Vores vikarer er vant til at arbejde i plejehjem, hjemmepleje, hospitaler og andre
                      sundhedsinstitutioner i Ringsted Kommune.
                    </p>
                  </motion.div>
                </div>
              </div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Ringsted by</strong>
                      </p>
                      <p>
                        • <strong>Benløse</strong>
                      </p>
                      <p>
                        • <strong>Jystrup</strong>
                      </p>
                      <p>
                        • <strong>Vigersted</strong>
                      </p>
                      <p>
                        • <strong>Ørslev</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Ringsted Kommune og Region Sjælland</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/vikarbureau-back.jpeg"
                        alt="Vikarbureau SOSU Ringsted - Vikarer med hjertet på det rette sted"
                        fill
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                ...
                Vores SOSU-vikarer arbejder ud fra princippet om{" "}
                <strong>at møde borgeren dér, hvor vedkommende er</strong>, med nærvær, ro og respekt.
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Professionel håndtering af udfordrende situationer</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Professionel SOSU-vikar i varm samtale med ældre borger - nærværende og forstående pleje"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    SOSU-assistenter og SOSU-hjælpere – Hvad er forskellen?
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Hos Tryghedspersonale.dk leverer vi både <strong>SOSU-assistenter</strong> og{" "}
                <strong>SOSU-hjælpere</strong> – to forskellige uddannelser med hver deres kompetencer.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>SOSU-assistenter</strong> har en længere uddannelse og kan varetage mere komplekse plejeopgaver,
                herunder medicingivning, sårpleje og dokumentation. De arbejder ofte selvstændigt og kan indgå i
                tværfaglige teams.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                <strong>SOSU-hjælpere</strong> har en kortere uddannelse og varetager primært praktiske plejeopgaver som
                personlig pleje, hjælp til måltider og mobilitet. De arbejder ofte under supervision af en
                SOSU-assistent eller sygeplejerske.
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Vores SOSU-vikarer kan
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Personlig pleje og omsorg</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Medicingivning og sårpleje (SOSU-assistenter)</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Hjælp til måltider og mobilitet</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Dokumentation og faglig kommunikation</span>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Hvor leverer vi SOSU-vikarer i Ringsted?
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i Ringsted</strong>, og vi har et stærkt netværk af dygtige
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Ringsted by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Benløse</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Jystrup</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Vigersted</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Ørslev</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Ringsted Kommune og Region Sjælland</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Hvorfor vælge Tryghedspersonale.dk som jeres SOSU-vikarbureau i Ringsted?
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi kalder os ikke tryghedspersonale uden grund. Vores team består af nøje udvalgte vikarer, som{" "}
              <strong>brænder for det sociale og sundhedsfaglige arbejde</strong> og som forstår, hvor vigtigt det er at
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">inden for sundhed og pleje</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 max-w-4xl mx-auto leading-tight">
              Akut hjælp – Vi er klar til at rykke ud med kort varsel
            </h2>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Sygdom, ferie eller pludselige udfordringer kan opstå uden varsel. Når I står i en situation, hvor I
                akut mangler SOSU-personale, er vi klar til at hjælpe.
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Akut udrykning ved sygdom eller ferie</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Planlagte vikarløsninger</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Længerevarende vikariater</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Aflastning i pressede perioder</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-200">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Vi <strong>stabiliserer situationen</strong>, skaber ro og hjælper med at holde dagligdagen kørende,
                  indtil en varig løsning er på plads. Ring til os på <strong>41 44 33 33</strong>, og lad os tage en
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Tryghedspersonale.dk - Akut hjælp med SOSU-vikarer - Ring 41 44 33 33"
                    fill
                    className="object-cover select-none pointer-events-none"
                    sizes="(max-width: 1024px) 100vw, 40vw"
                    draggable={false}
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Ringsted og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> vikarbureau SOSU Ringsted, SOSU-vikarer Ringsted, SOSU-assistenter Ringsted,
              SOSU-hjælpere Ringsted, vikar til plejehjem Ringsted, vikar til hjemmepleje Ringsted, sundhedsvikarer
              Ringsted, akut SOSU-vikar Sjælland, vikarbureau sundhed Region Sjælland
            </p>
            <p>
              Vi dækker: Ringsted, Benløse, Jystrup, Vigersted, Ørslev og øvrige dele af Ringsted Kommune og Region
              Sjælland
            </p>
          </div>
        </div>
