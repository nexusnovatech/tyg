...
export default function NordsjaellandClientPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-red-50">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  ...
                  udviklende miljø for både borgere og dit faste personale i Nordsjælland.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Professionel pædagogisk vikar i Nordsjælland"
                  width={600}
                  height={400}
      ...
      {/* Rest of the component follows the same structure as Nakskov but with Nordsjælland-specific content */}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Kontakt os for pædagogiske vikarer i Nordsjælland
            </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">nordsjaelland@tryghedspersonale.dk</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">Nordsjælland og omegn</div>
                    </div>
                  </div>
                </div>
              </div>
