...
export default function AlbertslundClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Pædagogisk Vikarbureau Albertslund - Erfarne og empatiske vikarer",
      title: "Erfarne og empatiske vikarer til bosteder og institutioner",
      subtitle:
        "At finde den rette pædagogiske vikar til dit bosted eller institution i Albertslund kræver, at man har både faglighed og empati i højsædet. Hos Tryghedspersonale.dk tilbyder vi erfarne, kompetente og empatiske vikarer, der brænder for at gøre en forskel i borgernes liv.",
    },
    {
      src: "/koege-psykiatrisk-vikar-caring.png",
      alt: "Pædagogiske vikarer med bred faglig baggrund i Albertslund",
      title: "Vikarer fra mange forskellige fagområder",
      subtitle:
        "Vore vikarer kommer fra mange forskellige fagområder og bringer derfor en bred vifte af kompetencer med sig. Vi har pædagoger, social- og sundhedsassistenter, ambulancebehandlere, politibetjente og flere – alle med forståelse for arbejdet med mennesker med særlige behov.",
    },
    {
      src: "/professional-man-suit.png",
      alt: "Professionel pædagogisk støtte i Albertslund",
      title: "Skaber tryghed og udvikling for borgerne",
      subtitle:
        "Når du vælger os som din samarbejdspartner, får du mere end bare en vikar. Du får en person, der er dedikeret til at skabe tryghed og udvikling for borgerne i din institution eller dit bosted.",
    },
  ]

  const services = [
    {
      title: "Pædagogiske vikarer",
      subtitle: "Til bosteder og institutioner",
      description:
        "Erfarne pædagoger specialiseret i at arbejde med unge og voksne med særlige behov og uforudsigelig adfærd.",
      image:
    ...
    },
    {
      ...
      subtitle: "Sundhedsfaglig viden og pædagogisk erfaring",
      description: "SSA'er der kan assistere med sundhedsmæssige opgaver, personlig pleje og daglige gøremål.",
      image:
    ...
    },
    {
      ...
      subtitle: "Akutte og pressede situationer",
      description: "Trænede til at håndtere akutte situationer og skabe ro med deres erfaring i pressede situationer.",
      image:
    ...
    {
      title: "Politibetjente",
      subtitle: "Konfliktløsning og deeskalering",
      description:
        "Erfaring med konfliktløsning og deeskalering af situationer, når uforudsigelig adfærd er en udfordring.",
      image:
    ...
    },
    {
      ...
      subtitle: "Komplekse adfærdsudfordringer",
      description: "Specialiseret i at arbejde med komplekse adfærdsudfordringer og særlige behov.",
      image:
  ...
  const data = allCityInfo["paedagogisk-vikarbureau-albertslund"]
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et pædagogisk vikarbureau i Albertslund?
              </h3>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-8 text-gray-900">
              Vores specialområder i Albertslund
            </h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Vi tilbyder vikarer fra forskellige fagområder til bosteder og institutioner
            </p>
          </motion.div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                {data.welcome.title} – Erfarne og Empatiske Vikarer til Bosteder og Institutioner
              </h2>
            </motion.div>
                ...
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Hvorfor vælge Tryghedspersonale.dk i Albertslund?
                    </h3>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <a href={`tel:${data.welcome.contact.phoneNumber.replace(/\s/g, "")}`}>
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src={data.welcome.image.src || "/placeholder.svg"}
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">{data.mission.title}</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">{data.mission.description}</p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              {data.mission.paragraphs.map((paragraph, index) => (
                <p key={index} className="text-xl text-gray-700 leading-relaxed font-medium">
                  {paragraph}
                </p>
              ))}
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  {data.mission.approachTitle}
                </h3>
                <div className="space-y-4">
                  {data.mission.approachList.map((item, index) => (
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src={data.mission.image.src || "/placeholder.svg"}
                    alt={data.mission.image.alt}
                    fill
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">{data.relief.title}</h2>
                </div>
                <h2 className="text-3xl font-bold text-gray-900 mb-8 lg:hidden">{data.relief.title}</h2>
              </div>
              {data.relief.paragraphs.map((paragraph, index) => (
                <p key={index} className="text-xl text-gray-700 leading-relaxed font-medium">
                  {paragraph}
                </p>
              ))}
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    src={data.relief.image.src || "/placeholder.svg"}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">{data.local.title}</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">{data.local.description}</p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="grid md:grid-cols-1 gap-6">
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    {data.local.coverageAreas.map((area, index) => (
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8">{data.local.localKnowledgeDescription}</p>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">{data.humanity.title}</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">{data.humanity.description}</p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto">
                ...
                {data.humanity.listItems.map((item, index) => (
                  <div key={index} className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                    <div className="flex items-start mb-4">
                      <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-2">{item.strongText}</h4>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
              className="text-center bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100"
            >
              <p className="text-xl text-gray-700 leading-relaxed">
                <strong className="text-gray-900">{data.humanity.conclusion.strongText}</strong>{" "}
                {data.humanity.conclusion.description}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            <motion.div
              ...
              className="lg:col-span-3 space-y-8"
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">{data.specialities.subtitle}</p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {data.specialities.listItems.map((item, index) => (
                    <div key={index} className="flex items-start">
                      <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                      <div>
                        <span className="text-lg text-gray-700 font-medium">{item.strongText}</span>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-200">
                <p className="text-lg text-gray-700 leading-relaxed">{data.specialities.conclusion}</p>
              </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/professional-man-suit.png"
                    alt="Professionel pædagogisk vikar i Albertslund"
                    fill
                    className="object-cover select-none pointer-events-none"
                    sizes="(max-width: 1024px) 100vw, 40vw"
                    draggable={false}
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Albertslund og omegn
            </h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Har I brug for pædagogiske vikarer? Kontakt os i dag, og lad os finde den rette vikar til dig og dine
              borgere i Albertslund.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4">Fleksibel hjælp</h3>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> pædagogisk vikarbureau Albertslund, pædagogiske vikarer Albertslund, vikar til
              bosted Albertslund, social- og sundhedsassistenter vikarer, ambulancebehandlere vikarer, politibetjente
              vikarer, specialpædagogiske vikarer Albertslund, tryghedspersonale Albertslund, vikarbureau
              hovedstadsområdet
            </p>
            <p>Vi dækker: Albertslund Kommune, hele hovedstadsområdet, bosteder, institutioner og specialtilbud</p>
          </div>
        </div>
      </section>
    </div>
