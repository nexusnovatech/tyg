...
export default function FrederiksbергClientPage() {
  ...
  const heroSlides = [
    {
      src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Y4XgmoAdiB3BUV53YHOWWZrqidHTEI.png",
      alt: "Psykiatrisk Vikarbureau Frederiksberg - Nærværende, lyttende og forstående",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede psykiatriske vikarbureau på Frederiksberg. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både kommunale og private.",
    },
    {
      src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image%201-YrZF5sYd3VxfF1w18AUqazpypno2ma.png",
      alt: "Tryghedspersonale der støtter ældre borger på Frederiksberg",
    ...
    },
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i park på Frederiksberg",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre på Frederiksberg og i hele Region Hovedstaden. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Frederiksberg & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau på Frederiksberg?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Psykiatrisk Vikarbureau på Frederiksberg med vikarer med hjertet på det rette
                sted
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    At finde den rette pædagogiske vikar til dit bosted eller din institution kan føles som en
                    uoverkommelig opgave, især når du arbejder med <strong>unge og voksne med særlige behov</strong>,
                    herunder personer med <strong>uforudsigelig adfærd</strong>. Hos{" "}
                    <strong>Tryghedspersonale.dk</strong> forstår vi, hvor vigtigt det er, at du kan stole på, at den,
                    du bringer ind, ikke bare er en vikar, men en person, der virkelig kan gøre en forskel i hverdagen.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi har dygtige vikarer med baggrund som <strong>pædagoger</strong>,{" "}
                    <strong>social- og sundhedsassistenter (SSA'er)</strong>, <strong>ambulancebehandlere</strong>,{" "}
                    <strong>politibetjente</strong> og mange andre – personer, der har en passion for at hjælpe, støtte
                    og gøre en forskel for de mennesker, de arbejder med. Vore vikarer kommer fra en række forskellige
                    fagområder, men de har én ting tilfælles: De er dedikerede til at sikre, at dem, de arbejder med,
                    føler sig trygge, respekterede og støttede.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Frederiksberg Kommune</strong>
                      </p>
                      <p>
                        • <strong>Frederiksberg C</strong>
                      </p>
                      <p>
                        • <strong>Vanløse</strong>
                      </p>
                      <p>
                        • <strong>Brønshøj</strong>
                      </p>
                      <p>
                        • <strong>Valby</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Region Hovedstaden</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Y4XgmoAdiB3BUV53YHOWWZrqidHTEI.png"
                    alt="Tryghedsmedarbejder der støtter ældre borger på Frederiksberg"
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt psykiatrisk vikarbureau på Frederiksberg og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret på Frederiksberg</strong>, og vi har et stærkt netværk af
              dygtige vikarer, der kender området og de kommunale arbejdsgange.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Frederiksberg C</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Vanløse</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Brønshøj</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Valby</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Nørrebro</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Frederiksberg Kommune og Region Hovedstaden</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe på Frederiksberg og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Frederiksberg, psykiatriske vikarer på Frederiksberg,
              vikar demens Frederiksberg, ekstern psykiatrisk støtte Frederiksberg, akut vikar psykiatri Hovedstaden,
              socialpsykiatrisk vikarbureau Frederiksberg, vikar til bosted Vanløse, tryghedspersonale Brønshøj og
              Valby, vikarbureau psykiatri Region Hovedstaden, pædagogisk vikarbureau Frederiksberg
            </p>
            <p>
              Vi dækker: Frederiksberg Kommune, Frederiksberg C, Vanløse, Brønshøj, Valby, Nørrebro og øvrige dele af
              Region Hovedstaden
            </p>
          </div>
        </div>
