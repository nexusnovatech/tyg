...
export default function NaestvedClientPage() {
  ...
  const heroSlides = [
    {
      src: "/naestved-hero.png",
      alt: "Psykiatrisk Vikarbureau Næstved - Nærværende, lyttende og forstående",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede psykiatriske vikarbureau i Næstved og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både kommunale og private.",
    },
    {
      src: "/naestved-image-1.png",
      alt: "Tryghedsmedarbejder der støtter ældre borger i Næstved",
    ...
    },
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i park i Næstved",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Næstved Kommune og hele Region Sjælland. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Næstved & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Næstved?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Specialiseret psykiatrisk vikarbureau i Næstved
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    <strong>Tryghedspersonale.dk</strong> tilbyder kompetent og fagligt funderet vikarbistand til
                    bosteder, plejecentre og socialpsykiatriske tilbud i <strong>Næstved Kommune og omegn</strong>. Vi
                    bistår kommunale enheder med midlertidig, akut og planlagt vikardækning, når der opstår behov for
                    ekstra ressourcer i håndteringen af borgere med komplekse psykiatriske, demensrelaterede eller
                  ...
                  >
                    Vores specialiserede vikarpersonale har solid erfaring med borgere, der kræver særlig indsats,
                    herunder borgere med udadreagerende adfærd, demens eller psykisk mistrivsel.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Fagligt kvalificeret personale til komplekse opgaver
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Psykiatriske borgere</strong>
                          <p className="text-gray-700 text-sm">med komplekse behov</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">inkl. udadreagerende adfærd</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Socialpsykiatriske tilbud</strong>
                          <p className="text-gray-700 text-sm">og specialiserede botilbud</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">og low arousal-metoder</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-700 mt-6">
                      Vi stiller kun personale til opgaver, der matcher det faglige niveau og den specifikke udfordring
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Næstved by</strong>
                      </p>
                      <p>
                        • <strong>Fensmark</strong>
                      </p>
                      <p>
                        • <strong>Rønnebæk</strong>
                      </p>
                      <p>
                        • <strong>Mogenstrup</strong>
                      </p>
                      <p>
                        • <strong>Glumsø</strong>
                      </p>
                      <p>
                        • <strong>Herlufmagle</strong>
                      </p>
                      <p>
                        • <strong>Stenlille og omegn</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt fokus og hurtig respons i Næstved Kommune
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi dækker hele Næstved Kommune med lokalkendskab, hvilket sikrer hurtig tilstedeværelse og en god
              forståelse for kommunens drift og samarbejdsformer.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vores vikarer har lokalkendskab, hvilket sikrer hurtig tilstedeværelse og en god forståelse for
                kommunens drift og samarbejdsformer. Vi prioriterer dialog og gennemsigtighed i samarbejdet med
                kommunale ledere og medarbejdere.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                Vores rolle er at støtte og aflaste, ikke at overtage ansvar eller rutiner. Derfor tilpasses indsatsen
                altid efter kommunens behov, gældende arbejdsmiljø og borgerens individuelle planer.
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">Akut vikardækning ved pludselige behov</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Planlagt vikardækning ved sygdom, ferie eller udsatte perioder
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Langtidsvikarer til længerevarende forløb</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Fleksibel og løsningsorienteret support</span>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Når behovet overstiger kommunale ressourcer
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                I praksis oplever vi, at faste personalegrupper nogle gange står i situationer, hvor borgernes behov
                overstiger de tilgængelige ressourcer.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                I disse tilfælde kan Tryghedspersonale.dk tilbyde vikarer, som sikrer kontinuitet og ro, og aflaster det
                faste personale i overgangsperioder, indtil en varig løsning er på plads.
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Akut optrapning i adfærd</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Forflytninger eller overgangsperioder, der kræver ekstra bemanding
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Midlertidige personalemangel på grund af sygdom eller ferie
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Situationen, hvor en borger udviser komplekse adfærdsudfordringer
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Et tillidsfuldt samarbejde med kommunen
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi prioriterer dialog og gennemsigtighed i samarbejdet med kommunale ledere og medarbejdere. Vores rolle
              er at støtte og aflaste, ikke at overtage ansvar eller rutiner.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Næstved by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Fensmark</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Rønnebæk</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Mogenstrup</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Glumsø</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Herlufmagle</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Derfor tilpasses indsatsen altid efter</h3>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Kommunens behov</strong>
                    <p className="text-gray-700">Vi tilpasser os jeres specifikke krav og arbejdsgange</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Gældende arbejdsmiljø</strong>
                    <p className="text-gray-700">Vi respekterer og følger etablerede procedurer og kultur</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Borgerens individuelle planer</strong>
                    <p className="text-gray-700">Vi arbejder inden for rammerne af borgerens handleplan</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Næstved og omegn
            </h2>
      ...
      <section className="py-16 bg-green-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Næstved, vikar psykiatri Næstved Kommune, demensvikar
              Næstved, vikardækning botilbud Næstved, socialpsykiatrisk vikar Næstved, vikar til §85 og §108 tilbud
              Næstved, akut vikardækning Næstved Kommune
            </p>
            <p>Vi dækker: Næstved by, Fensmark, Rønnebæk, Mogenstrup, Glumsø, Herlufmagle, Stenlille og omegn</p>
          </div>
        </div>
      </section>
    </div>
