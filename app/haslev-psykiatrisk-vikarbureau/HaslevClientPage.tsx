...
export default function HaslevClientPage() {
  ...
  const heroSlides = [
    {
      src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-xUnyLaYnO7aYt8FQtJDNYhn59EYsZY.png",
      alt: "Psykiatrisk Vikarbureau Haslev - Specialiseret i komplekse borgerforløb",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede psykiatriske vikarbureau i Haslev og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både kommunale og private.",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Haslev Kommune og hele Region Sjælland. Vores mål er at være jeres pålidelige partner.",
    },
  ]
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Psykiatrisk Vikarbureau i Haslev med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>psykiatrisk vikarbureau i Haslev</strong> og omegn. Vi leverer fagligt stærke, erfarne og
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Haslev by</strong>
                      </p>
                      <p>
                        • <strong>Faxe</strong>
                      </p>
                      <p>
                        • <strong>Rønnede</strong>
                      </p>
                      <p>
                        • <strong>Tureby</strong>
                      </p>
                      <p>
                        • <strong>Dalby</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Faxe Kommune og Region Sjælland</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt psykiatrisk vikarbureau i Haslev og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i Haslev</strong>, og vi har et stærkt netværk af dygtige
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Haslev by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Faxe</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
              ...
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Faxe Kommune og Region Sjælland</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Haslev, psykiatriske vikarer i Haslev, vikar demens
              Haslev, ekstern psykiatrisk støtte Haslev, akut vikar psykiatri Sjælland, socialpsykiatrisk vikarbureau
              Haslev, vikar til bosted i Faxe, tryghedspersonale Rønnede og Tureby, vikarbureau psykiatri Region
              Sjælland
            </p>
            <p>Vi dækker: Haslev, Faxe, Rønnede, Tureby, Dalby og øvrige dele af Faxe Kommune og Region Sjælland</p>
          </div>
        </div>
      </section>
    </div>
