      ...
      <section className="relative bg-gradient-to-br from-gray-50 to-gray-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="bg-red-100 text-red-800 mb-4">Pædagogisk Vikarbureau Køge</Badge>
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Pædagogiske vikarer med nærvær, erfaring og specialviden
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Hos Tryghedspersonale.dk er vi specialiseret i at levere pædagogiske vikarer til det komplekse område.
                Vi hjælper institutioner i Køge og omegn med at finde stabile, kompetente og menneskeligt stærke
                vikarer.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Specialiserede pædagogiske vikarer til komplekse indsatser
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-2 hover:border-red-200 transition-colors">
              <CardHeader>
                ...
                <CardTitle>Botilbud og §108-enheder</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Erfaring fra botilbud og §108-enheder for unge og voksne med komplekse behov.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-red-200 transition-colors">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Institutioner for børn og unge med udviklingsforstyrrelser eller adfærdsproblematikker.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-red-200 transition-colors">
              <CardHeader>
                ...
                <CardTitle>Behandlingssteder</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Behandlings- og opholdssteder med skærmede miljøer og specialiseret omsorg.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-red-200 transition-colors">
              <CardHeader>
                ...
                <CardTitle>Socialpsykiatriske tilbud</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">Socialpsykiatriske tilbud med behov for ro, struktur og tryghed.</p>
              </CardContent>
            </Card>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Pædagogisk vikarbureau i Køge – med specialviden og lokalt fokus
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Vi dækker pædagogiske vikarbehov i hele Køge Kommune med lokalt kendskab og hurtig respons.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              <Image
                ...
                alt="Specialiseret pædagogisk vikar"
                width={600}
                height={400}
                className="rounded-lg shadow-xl"
              />
      ...
      <section className="py-20 bg-red-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
            Brug for specialiseret pædagogisk vikarhjælp i Køge?
          </h2>
          ...
          <p className="text-red-100 mt-6">🚨 Vi tilbyder hurtig og tryg vikarbistand i Køge og omegn</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Specialiseret i pædagogiske vikarer til komplekse miljøer i Køge og omegn.
              </p>
            </div>
