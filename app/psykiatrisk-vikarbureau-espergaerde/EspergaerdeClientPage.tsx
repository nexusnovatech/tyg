...
export default function EspergaerdeClientPage() {
  ...
  const heroSlides = [
    {
      src: "/espergaerde-hero.png",
      alt: "Psykiatrisk Vikarbureau Espergærde - Specialiseret i komplekse borgerforløb",
      title: "Specialiseret i komplekse borgerforløb",
      subtitle:
        "Tryghedspersonale.dk tilbyder specialiseret og fagligt kompetent vikardækning til botilbud, plejecentre og socialpsykiatriske enheder i Espergærde og omegn. Når komplekse psykiatriske, sociale eller demensrelaterede udfordringer opstår, stiller vores erfarne vikarer hurtigt og professionelt op.",
    },
    {
      src: "/tryghedspersonale-aeldre-stoette.jpeg",
      alt: "Tryghedsmedarbejder der støtter ældre borger i Espergærde",
      title: "Faglig støtte når det bliver nødvendigt",
      subtitle:
        "Vi forstår, at midlertidig ekstra bemanding ofte er nødvendig for at kunne håndtere situationer med udadreagerende adfærd, kriser eller ved personalemangel. Vores vikare bidrager med både faglighed og empati, så borgernes trivsel og et godt arbejdsmiljø opretholdes.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i Espergærde",
      title: "Kompetent og empatisk personale",
      subtitle:
        "Vores vikare har relevant uddannelse og stor erfaring inden for psykiatri, socialpædagogik og demenspleje. De er social- og sundhedsassistenter, pædagoger eller har tilsvarende erfaring med indsigt i konflikthåndtering og relationsarbejde.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Espergærde & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Espergærde?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Psykiatrisk Vikarbureau Espergærde
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Tryghedspersonale.dk tilbyder specialiseret og fagligt kompetent vikardækning til botilbud,
                    plejecentre og socialpsykiatriske enheder i Espergærde og omegn. Når komplekse psykiatriske, sociale
                    eller demensrelaterede udfordringer opstår, stiller vores erfarne vikarer hurtigt og professionelt
                    op for at sikre stabilitet og tryghed for både borgere og personale.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi forstår, at midlertidig ekstra bemanding ofte er nødvendig for at kunne håndtere situationer med
                    udadreagerende adfærd, kriser eller ved personalemangel. Vores vikare bidrager med både faglighed og
                    empati, så borgernes trivsel og et godt arbejdsmiljø opretholdes.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Når ekstra faglig støtte bliver nødvendig
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Ved udadreagerende adfærd</strong>
                          <p className="text-gray-700 text-sm">hvor en rolig og struktureret tilgang skaber tryghed</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">I akutte krisesituationer</strong>
                          <p className="text-gray-700 text-sm">hvor der er behov for øget opmærksomhed</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Ved personalemangel</strong>
                          <p className="text-gray-700 text-sm">som midlertidigt svækker bemandingen</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Ved komplekse udfordringer</strong>
                          <p className="text-gray-700 text-sm">som kræver ekstra faglig indsats</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90 mb-4">Har du behov for faglig vikardækning i Espergærde?</p>
                    <a href="tel:41443333">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Dækker Espergærde og omegn</h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Espergærde centrum</p>
                      <p>• Nærmeste opland</p>
                      <p>• Hurtig respons ved akut behov</p>
                      <p>• Planlagt vikardækning</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/espergaerde-hero.png"
                        alt="Psykiatrisk vikar i Espergærde - professionel omsorg og støtte"
                        fill
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/espergaerde-hero.png"
                    alt="Professionel psykiatrisk vikar i Espergærde - nærværende og forstående pleje"
                    fill
      ...
      {/* Kompetent og empatisk personale Section */}
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Kompetent og empatisk personale</h2>
                </div>
                <h2 className="text-3xl font-bold text-gray-900 mb-8 lg:hidden">Kompetent og empatisk personale</h2>
              </div>
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vores vikare har relevant uddannelse og stor erfaring inden for psykiatri, socialpædagogik og
                demenspleje.
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">
                      Er social- og sundhedsassistenter, pædagoger eller har tilsvarende erfaring
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Har indsigt i konflikthåndtering, low arousal-metoder og relationsarbejde
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Kender til psykiatriske diagnoser, dobbeltdiagnoser og demensrelaterede problemstillinger
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Er vant til tværfagligt samarbejde og dokumentation</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Arbejder med respekt for borgerens individuelle livssituation
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    src="/tryghedspersonale-aeldre-stoette.jpeg"
                    alt="Kompetent psykiatrisk vikar i Espergærde med erfaring i demenspleje"
                    fill
      ...
      {/* Typiske opgaver og målgrupper Section */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">Typiske opgaver og målgrupper</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">Vi støtter især i:</p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">
                        §85 støtteforløb med midlertidigt øgede behov
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-red-500 rounded-full mr-4 flex-shrink-0"></div>
                      <span className="text-lg font-semibold text-gray-900">
                        §108 botilbud, hvor særlig psykiatrisk viden er nødvendig
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-red-500 rounded-full mr-4 flex-shrink-0"></div>
                      <span className="text-lg font-semibold text-gray-900">
                        Demensenheder, hvor tryghed og genkendelighed er essentielle
                      </span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-red-500 rounded-full mr-4 flex-shrink-0"></div>
                      <span className="text-lg font-semibold text-gray-900">
                        Socialpsykiatriske miljøer med udadreagerende og kompleks adfærd
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-red-500 rounded-full mr-4 flex-shrink-0"></div>
                      <span className="text-lg font-semibold text-gray-900">
                        Ungeområder med specialpædagogiske og psykosociale udfordringer
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Fleksible og tryghedsskabende løsninger</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">Vi tilbyder:</p>
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">ved sygdom, ferie og ledige stillinger</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Længerevarende vikarløsninger</strong>
                    <p className="text-gray-700">ved komplekse eller langvarige behov</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Tæt dialog</strong>
                    <p className="text-gray-700">med ledelse og personale for at sikre kvalitet og relevant indsats</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section id="kontakt" className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Kontakt os i Espergærde</h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Har du behov for faglig vikardækning til botilbud, plejecenter eller socialpsykiatrisk enhed i Espergærde?
              Vi står klar med både akut og længerevarende vikarløsninger.
            </p>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Espergærde, vikardækning botilbud Espergærde, vikar ved
              udadreagerende adfærd Espergærde, demensvikar Espergærde, socialpsykiatrisk vikar Espergærde, midlertidig
              vikar Espergærde §85 §108
            </p>
            <p>
              Vi dækker hele Espergærde-området og nærmeste opland med hurtig respons ved akut eller planlagt behov.
            </p>
          </div>
        </div>
      </section>
