...
export default function KoegeClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Psykiatrisk Vikarbureau Køge - Nærværende, lyttende og forstående",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede psykiatriske vikarbureau i Køge og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både kommunale og private.",
    },
    {
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Køge?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Psykiatrisk Vikarbureau i Køge med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>psykiatriske vikarbureau i Køge</strong> og omegn. Vi leverer fagligt stærke, erfarne og
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Køge by</strong>
                      </p>
                      <p>
                        • <strong>Herfølge</strong>
                      </p>
                      <p>
                        • <strong>Borup</strong>
                      </p>
                      <p>
                        • <strong>Solrød Strand</strong>
                      </p>
                      <p>
                        • <strong>Ejby</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Køge Kommune og Region Sjælland</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        ...
                        alt="Psykiatrisk Vikarbureau Køge - Vikarer med hjertet på det rette sted"
                        fill
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt psykiatrisk vikarbureau i Køge og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i Køge</strong>, og vi har et stærkt netværk af dygtige vikarer,
              der kender området og de kommunale arbejdsgange.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Køge by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Herfølge</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Borup</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Solrød Strand</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Ejby</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Køge Kommune og Region Sjælland</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
