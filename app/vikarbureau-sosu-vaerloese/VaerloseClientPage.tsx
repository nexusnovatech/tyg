...
export default function VaerloseClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Vikarbureau SOSU Værløse - Professionelle SOSU-assistenter og SOSU-hjælpere",
      title: "Erfarne SOSU-vikarer til Værløse og omegn",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og professionelle vikarbureau SOSU Værløse. Vi leverer kompetente og fleksible social- og sundhedsassistenter (SOSU-assistenter) samt social- og sundhedshjælpere (SOSU-hjælpere) til plejehjem, hjemmepleje og hospitaler.",
    },
    {
      src: "/vikarbureau-indoor.jpeg",
      alt: "SOSU-vikar der støtter ældre borger i Værløse",
      title: "Kvalificeret pleje og omsorg",
      subtitle:
        "Vores SOSU-personale er erfarne og uddannede til at levere professionel pleje og omsorg. Vi sikrer, at vores vikarer matcher jeres behov og kan træde til med kort varsel.",
    },
    {
      src: "/vikarbureau-outdoor.jpeg",
      alt: "SOSU-vikar i samtale med borger i Værløse",
      title: "Fleksible løsninger når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejecentre, hjemmepleje og sundhedsinstitutioner i Værløse, Farum, Hareskovby og Stenløse. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  const data = allCityInfo["vikarbureau-sosu-vaerloese"]

  return (
    <div className="min-h-screen">
      {/* Enhanced Hero Section */}
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Værløse & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et SOSU Vikarbureau i Værløse?
              </h3>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Vi tilbyder specialiserede vikarer til forskellige områder inden for sundhed og pleje
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <Badge className="bg-red-100 text-red-600 mb-6 text-sm px-4 py-2">Vikarbureau SOSU</Badge>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Vikarbureau SOSU Værløse – Din lokale partner i sundhed og pleje
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>vikarbureau SOSU Værløse</strong>, der leverer kompetente og fleksible social- og
                  ...
                  >
                    Værløse er en aktiv by i <strong>Furesø Kommune</strong> med plejecentre, hjemmeplejeordninger og
                    sundhedstilbud, der har brug for kvalificeret personale. Vi kender området og forstår de lokale
                    behov – og vi er klar til at levere den rette hjælp, når I har brug for det.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <strong className="text-gray-900">Erfarne SOSU-vikarer</strong>
                          <p className="text-gray-700 text-sm">
                            med dokumenteret uddannelse og praktisk erfaring fra sundhedssektoren
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            Vi kan levere vikarer med kort varsel – også i weekender og på helligdage
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            Vi kender Værløse og omegn og forstår de lokale arbejdsgange
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Personlig service</strong>
                          <p className="text-gray-700 text-sm">
                            Vi matcher vikaren til jeres specifikke behov og arbejdskultur
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Værløse</strong>
                      </p>
                      <p>
                        • <strong>Farum</strong>
                      </p>
                      <p>
                        • <strong>Hareskovby</strong>
                      </p>
                      <p>
                        • <strong>Stenløse</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Furesø Kommune</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        ...
                        alt="Vikarbureau SOSU Værløse - Erfarne SOSU-vikarer"
                        fill
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi leverer både SOSU-assistenter og SOSU-hjælpere, afhængigt af jeres behov
            </p>
          </motion.div>
            ...
            >
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  En <strong>SOSU-assistent</strong> har gennemført en 2-årig erhvervsuddannelse og kan varetage
                  komplekse plejeopgaver som:
                </p>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Medicingivning og sårpleje</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Rehabilitering og genoptræning</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Observation og dokumentation</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Samarbejde med sygeplejersker og læger</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  En <strong>SOSU-hjælper</strong> har gennemført et kortere uddannelsesforløb (typisk 1 år) og
                  varetager primært praktiske plejeopgaver som:
                </p>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Personlig pleje og hygiejne</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Praktisk bistand i hverdagen</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Social kontakt og omsorg</span>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Hvor leverer vi SOSU-vikarer i Værløse?
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi leverer SOSU-vikarer til en bred vifte af institutioner og arbejdspladser i Værløse og omegn,
                herunder:
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Vores leveringsområder
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Plejecentre og ældrepleje</strong> – både kommunale og private
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Hjemmepleje</strong> – til borgere i eget hjem
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Hospitaler og sundhedshuse</strong> – akut og planlagt
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Rehabiliteringscentre</strong> – genoptræning og pleje
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Botilbud og bosteder</strong> – for borgere med særlige behov
                    </span>
                  </div>
                </div>
              </div>
              <p className="text-lg text-gray-700 leading-relaxed">
                Uanset om I har brug for en vikar til en enkelt vagt eller en længerevarende periode, kan vi hjælpe jer
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Hvorfor vælge Tryghedspersonale.dk som jeres SOSU-vikarbureau i Værløse?
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi er mere end bare et vikarbureau – vi er jeres lokale partner i sundhed og pleje
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Vores fordele</h3>
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <strong className="text-gray-900 text-lg">Erfaring og faglighed</strong>
                      <p className="text-gray-700">
                        Alle vores vikarer er uddannede og erfarne inden for sundhedssektoren
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <strong className="text-gray-900 text-lg">Fleksibilitet</strong>
                      <p className="text-gray-700">
                        Vi kan levere vikarer med kort varsel – også i weekender og på helligdage
                      </p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <strong className="text-gray-900 text-lg">Lokalt kendskab</strong>
                      <p className="text-gray-700">
                        Vi kender Værløse og omegn og forstår de lokale arbejdsgange og behov
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Sådan arbejder vi</h3>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">1. Kontakt os</strong>
                    <p className="text-gray-700">Ring eller skriv til os med jeres behov</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">2. Vi matcher</strong>
                    <p className="text-gray-700">Vi finder den rette vikar til jeres specifikke behov</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">3. Hurtig levering</strong>
                    <p className="text-gray-700">Vi leverer vikaren hurtigt – ofte samme dag</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">4. Opfølgning</strong>
                    <p className="text-gray-700">Vi følger op for at sikre, at I er tilfredse</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi ved, at behovet for vikarer kan opstå pludseligt – fx ved sygdom, ferie eller uforudsete situationer.
                Derfor tilbyder vi <strong>akut udrykning</strong>, så I hurtigt kan få den hjælp, I har brug for.
              </p>

              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Vores akutte service
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Hurtig responstid</strong> – Vi kan ofte levere en vikar samme dag
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Døgnservice</strong> – Vi er tilgængelige alle ugens dage
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Erfarne vikarer</strong> – Vores vikarer er klar til at træde til med det samme
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Fleksible løsninger</strong> – Vi tilpasser os jeres behov og situation
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  Ring til os på <strong>41 44 33 33</strong>, og lad os hjælpe jer med at finde den rette løsning –
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Værløse og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> vikarbureau SOSU Værløse, SOSU-vikarer Værløse, SOSU-assistent vikar Værløse,
              SOSU-hjælper vikar Værløse, vikar til plejehjem Værløse, vikar til hjemmepleje Værløse, sundhedspersonale
              Værløse, akut vikar SOSU Furesø Kommune, vikarbureau sundhed Værløse, SOSU-vikarer Farum
            </p>
            <p>Vi dækker: Værløse, Farum, Hareskovby, Stenløse og øvrige dele af Furesø Kommune</p>
          </div>
        </div>
      </section>
    </div>
