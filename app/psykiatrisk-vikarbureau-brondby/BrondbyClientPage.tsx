...
export default function BrondbyClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Brøndby",
    ...
    },
    {
      ...
      alt: "Tryghedsmedarbejder der støtter ældre borger i Brøndby",
      title: "Specialiseret i socialpsykiatri",
      subtitle:
        "Som psykiatrisk vikarbureau i Brøndby forstår vi de særlige udfordringer, der opstår i arbejdet med borgere med psykiske lidelser, demens og udviklingsforstyrrelser. Vores vikarer har omfattende erfaring med at skabe trygge rammer og professionelle relationer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Brøndby",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Brøndby Kommune og hele Region Hovedstaden. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Brøndby & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Brøndby?
              </h3>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <Badge className="bg-red-100 text-red-600 mb-6 text-sm px-4 py-2">
                Psykiatrisk Vikarbureau i Brøndby
              </Badge>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Når behovet overstiger egne ressourcer
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Tryghedspersonale.dk tilbyder specialiseret, midlertidig og fagligt kompetent bemanding til
                    botilbud, døgntilbud, plejecentre og §85/§108-indsatser i Brøndby. Vi leverer vikarer, som er rustet
                    til at håndtere komplekse psykiatriske og sociale udfordringer og bidrager til stabilitet og
                  ...
                  >
                    Der kan opstå situationer, hvor et botilbud eller plejecenter i Brøndby midlertidigt mangler
                    personale til at dække borgernes behov – hvad enten det skyldes sygdom, ferie, krisesituationer
                    eller komplekse forløb. I disse tilfælde træder vi til med vikarer, der ikke blot udfylder en vagt,
                    men aktivt bidrager til tryghed og ro.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <strong className="text-gray-900">
                            Håndtering af udadreagerende og uforudsigelig adfærd
                          </strong>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker Brøndby og omegn</h3>
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/brondby-hero.png"
                        alt="Psykiatrisk vikarbureau Brøndby - professionel håndtering af udadreagerende borgere"
                        fill
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vores vikarer er nøje udvalgte med relevant faglighed inden for social- og sundhedssektoren, pædagogik
                og psykiatri. De har erfaring fra lignende tilbud og kender til både kommunale rammer og de særlige
                krav, der stilles i plejeforløb med komplekse borgere.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                Vi forstår, at hver situation er unik. Derfor tilbyder vi fleksible vikarløsninger, der matcher det
                aktuelle behov og skaber tryghed for både borgere og personale.
              </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">
                      Har solid erfaring med konflikthåndtering og low arousal-tilgang
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Arbejder relationelt og med respekt for borgernes individuelle behov
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Integreres nemt i eksisterende teams og understøtter den pædagogiske linje
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Er vant til at dokumentere fagligt og samarbejde tværfagligt
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Professionel psykiatrisk vikar i varm samtale med ældre borger - nærværende og forstående pleje i Brøndby"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Fleksible løsninger med tryghed for alle parter
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi forstår, at hver situation er unik. Derfor tilbyder vi fleksible vikarløsninger, der matcher det
                aktuelle behov og skaber tryghed for både borgere og personale i Brøndby.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Vores vikarer har erfaring med en bred palette af opgaver og målgrupper, og vi tilpasser vores indsats
                efter jeres specifikke behov og udfordringer.
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Vores fleksible tilbud
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Akut indsats ved uforudsete hændelser</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Planlagt vikardækning ved ferie og sygdom</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                  ...
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Sparring og dialog med ledelse for at sikre en sammenhængende indsats
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    ...
                    alt="Professionel psykiatrisk vikar i Brøndby - fleksible løsninger og tryghed"
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokal og fagligt funderet bemanding i Brøndby
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi kender Brøndby Kommune og de lokale forhold, hvilket gør os til den ideelle partner for jeres
              vikarbureau
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Vi dækker Brøndby og omegn</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Brøndby</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Hvidovre</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Rødovre</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Vallensbæk</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Ishøj</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Albertslund</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>
                    Vi dækker også hele Region Hovedstaden og kan levere vikarer til hele Sjælland ved behov.
                  </strong>
                </p>
              </div>
            </motion.div>
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Målgrupper og opgavetyper i Brøndby</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Vores vikarer har erfaring med en bred palette af opgaver og målgrupper i Brøndby Kommune og omegn.
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">hvor borgerne midlertidigt har øgede behov</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                ...
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Demens- og plejeafsnit</strong>
                    <p className="text-gray-700">hvor tryghed og genkendelighed er centralt</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              className="mb-12"
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Vores tilgang til menneskelighed</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Vi møder hver borger med respekt og forståelse for deres individuelle situation
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Professionel omsorg</h4>
                      <p className="text-gray-700">
                        Vores vikarer kombinerer faglig ekspertise med ægte menneskelig omsorg
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Tryg tilstedeværelse</h4>
                      <p className="text-gray-700">
                        Vi skaber trygge rammer, hvor borgerne kan føle sig set og forstået
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Støtte til personalet</h4>
                      <p className="text-gray-700">
                        Vi aflaster og støtter det faste personale i udfordrende situationer
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100 inline-block">
                <p className="text-xl text-gray-700 leading-relaxed font-medium max-w-3xl">
                  <strong>Vores mål er at skabe stabilitet og tryghed</strong> i situationer, hvor både borgere og
                  personale har brug for ekstra støtte og professionel håndtering.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-xl font-semibold mb-8 text-gray-800">
                Vores vikarer er specialister i at håndtere komplekse borgersituationer med ro og professionalisme
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Udadreagerende adfærd:</strong> Erfaring med deeskalering og konflikthåndtering
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Demensrelaterede udfordringer:</strong> Specialiseret i BPSD og urolig adfærd
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Psykiatriske kriser:</strong> Akut stabilisering og professionel håndtering
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Komplekse forløb:</strong> Langvarig støtte og kontinuitet i behandlingen
                  </p>
                </div>
              </div>
              <p className="text-gray-700 mt-8 text-lg leading-relaxed">
                Vi arbejder altid ud fra en low arousal-tilgang og fokuserer på at skabe ro og stabilitet i pressede
                situationer.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                Vi sikrer en stabil og tryg vikarindsats, der skaber ro for både borgere, personale og ledelse. Vores
                mål er at være den pålidelige partner, I kan regne med i alle situationer.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                Kontakt os for professionel vikarbemanding i Brøndby – vi står klar til at hjælpe døgnet rundt.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            >
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Akut optrapning i en borgers adfærd</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Uforudsete personalemangel</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Forflytningssager, der trækker ud</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">
                      Uro i beboergrupper eller komplekse misbrugsforløb
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Tryghedspersonale.dk - Når en borger udviser udfordrende adfærd i Brøndby - Ring 41 44 33 33"
                    fill
                    className="object-cover select-none pointer-events-none"
                    sizes="(max-width: 1024px) 100vw, 40vw"
                    draggable={false}
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Brøndby og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Brøndby, vikar psykiatri Brøndby, demensvikar Brøndby,
              socialpsykiatrisk vikar Brøndby, vikardækning botilbud Brøndby, vikar §85 Brøndby
            </p>
            <p>
              Vi dækker: Brøndby, Hvidovre, Rødovre, Vallensbæk, Ishøj, Albertslund og øvrige dele af Region Hovedstaden
            </p>
          </div>
        </div>
      </section>
