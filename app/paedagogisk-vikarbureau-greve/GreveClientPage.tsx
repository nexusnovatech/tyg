...
import { Phone, Mail, Heart, Clock } from "lucide-react"
...
export default function GreveClientPage() {
  ...
  const heroSlides = [
    {
      src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image%201-vCAzHHRUbqrCBk8AIEITBPfJMRlBEo.png",
      alt: "Pædagogisk Vikarbureau Greve - Specialiseret i udadreagerende adfærd",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede pædagogiske vikarbureau i Greve og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til voksne- og ældreområdet, specialiseret i udadreagerende adfærd og komplekse borgerforløb.",
    },
    {
      src: "/greve-image-2-updated.png",
      alt: "Tryghedsmedarbejder der støtter voksen borger i Greve",
      title: "Specialiseret i udadreagerende adfærd",
      subtitle:
        "Vores personale er uddannet til at håndtere komplekse borgerforløb, hvor adfærd kan være uforudsigelig, udadreagerende eller præget af særlige behov. Det er netop i disse situationer, at det rigtige personale gør forskellen – og det er her, vi kommer ind i billedet.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Greve",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til botilbud, døgninstitutioner, opholdssteder og specialiserede enheder i Greve Kommune og hele Region Sjælland. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  const services = [
    {
      ...
      subtitle: "Professionel støtte og omsorg",
      description:
        "Erfarne vikarer til botilbud med ekspertise i håndtering af udadreagerende adfærd og komplekse borgerforløb.",
      image:
    ...
    {
      title: "Vikar til døgninstitutioner",
      subtitle: "Specialiseret støtte",
      description:
        "Vi tilbyder erfarne vikarer til døgninstitutioner med ekspertise i pædagogisk arbejde og konfliktløsning.",
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/vikar-asylcenter-udrejsecenter-Le60NIU22xLcNFcyMQnRp5hYIwVHaD.png",
      link: "/ydelser/doegninstitutioner",
    },
    {
      title: "Vikar til opholdssteder",
      subtitle: "Støtte til unge og voksne",
      description: "Fagligt stærke vikarer til opholdssteder og specialiserede enheder i hele landet.",
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Vikar%20til%20plejehjem%20-ie8pf3LdnULgPcd1zNXAQ0L2GQZPFX.png",
      link: "/ydelser/opholdssteder",
    },
    {
      title: "Vikar til krisecentre",
      subtitle: "Professionel krisestøtte",
      description: "Professionel krisestøtte til borgere ramt af vold, kontrol eller andre traumatiske oplevelser.",
      image:
    ...
    {
      title: "Vikar til specialenheder",
      subtitle: "Erfarne pædagogiske vikarer",
      description: "Erfarne vikarer til specialenheder med menneskelig indsigt, faglighed og kontinuitet i arbejdet.",
      image:
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et pædagogisk Vikarbureau i Greve?
              </h3>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Vi tilbyder specialiserede vikarer til forskellige områder inden for pædagogik og socialarbejde
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <Badge className="bg-red-100 text-red-600 mb-6 text-sm px-4 py-2">Pædagogisk Vikarbureau</Badge>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Pædagogisk Vikarbureau i Greve med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>pædagogiske vikarbureau i Greve</strong> og omegn. Vi leverer fagligt stærke, erfarne og
                    omsorgsfulde vikarer til voksne- og ældreområdet, specialiseret i udadreagerende adfærd og komplekse
                    borgerforløb.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    være uforudsigelig, udadreagerende eller præget af særlige behov. Det er netop i disse situationer,
                    at det rigtige personale gør forskellen – og det er her, vi kommer ind i billedet.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Specialister i voksne- og ældreområdet
                    </h3>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            Professionel håndtering af udfordrende adfærd hos voksne og ældre
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Botilbud og døgninstitutioner</strong>
                          <p className="text-gray-700 text-sm">Specialiseret støtte til borgere med særlige behov</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Pædagogisk arbejde</strong>
                          <p className="text-gray-700 text-sm">
                            Støtte til borgere med udviklingsforstyrrelser og sociale udfordringer
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-700 mt-6">
                      Vores vikarer er vant til at arbejde i både skærmede enheder, botilbud, døgninstitutioner,
                      opholdssteder og kommunale specialenheder.
                    </p>
                  </motion.div>
                </div>
              </div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Greve by</strong>
                      </p>
                      <p>
                        • <strong>Hundige</strong>
                      </p>
                      <p>
                        • <strong>Karlslunde</strong>
                      </p>
                      <p>
                        • <strong>Kildebrønde</strong>
                      </p>
                      <p>
                        • <strong>Tune</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Greve Kommune og Region Sjælland</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/greve-paedagogisk-vikar-caring.png"
                    alt="Professionel pædagogisk vikar i varm samtale med borger - nærværende og forstående støtte"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Greve og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> pædagogisk vikarbureau Greve, pædagogiske vikarer i Greve, vikar udadreagerende
              adfærd Greve, ekstern pædagogisk støtte Greve, akut vikar botilbud Sjælland, socialpædagogisk vikarbureau
              Greve, vikar til døgninstitution i Hundige, tryghedspersonale Karlslunde og Kildebrønde, vikarbureau
              pædagogik Region Sjælland
            </p>
            <p>
              Vi dækker: Greve, Hundige, Karlslunde, Kildebrønde, Tune og øvrige dele af Greve Kommune og Region
              Sjælland
            </p>
          </div>
        </div>
