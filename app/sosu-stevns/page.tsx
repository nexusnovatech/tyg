...
export default function SOSUStevnsPage() {
  return (
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white">
        ...
        <div className="container relative mx-auto px-4 py-24 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            <Badge className="mb-6 bg-white/20 text-white hover:bg-white/30 backdrop-blur-sm">SOSU Stevns</Badge>
            <h1 className="mb-6 text-4xl font-bold tracking-tight md:text-6xl text-balance">
              Bliv en del af sundhedsteamet i Stevns Kommune
            </h1>
            <p className="mb-8 text-xl text-blue-100 md:text-2xl text-pretty">
              Arbejd i smukke omgivelser og gør en forskel for borgerne i Stevns hver dag
            </p>
          ...
          <Card className="border-blue-200 bg-white shadow-lg hover:shadow-xl transition-shadow">
            <CardContent className="flex items-start gap-4 p-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Klintevej 2</p>
                <p className="text-sm text-gray-600">4660 Store Heddinge</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-200 bg-white shadow-lg hover:shadow-xl transition-shadow">
            <CardContent className="flex items-start gap-4 p-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">+45 56 88 16 00</p>
          ...
          <Card className="border-blue-200 bg-white shadow-lg hover:shadow-xl transition-shadow">
            <CardContent className="flex items-start gap-4 p-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">sosu@stevns.dk</p>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              <Badge className="mb-4 bg-blue-100 text-blue-700">Om SOSU Stevns</Badge>
              <h2 className="mb-6 text-3xl font-bold text-gray-900 md:text-4xl text-balance">
                Arbejd i hjertet af Stevns Kommune
              </h2>
              <p className="mb-6 text-lg text-gray-600 leading-relaxed">
                I Stevns Kommune kombinerer vi professionel pleje med et nært og personligt arbejdsmiljø. Her kender vi
                hinanden og arbejder tæt sammen om at give borgerne den bedste omsorg.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-blue-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Nært arbejdsmiljø</h3>
                    <p className="text-gray-600">Mindre teams med tæt samarbejde</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-blue-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Smukke omgivelser</h3>
                    <p className="text-gray-600">Arbejd i naturskønne Stevns</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-blue-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Faglig udvikling</h3>
                    <p className="text-gray-600">Mulighed for specialisering og videreuddannelse</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl text-balance">Arbejdsområder i Stevns</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="border-blue-200 bg-white hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Arbejd på vores plejecentre med fokus på livskvalitet</p>
                <Link href="#" className="text-blue-600 hover:text-blue-700 font-medium inline-flex items-center">
                  Læs mere <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
              </CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl text-balance">
              Klar til at starte din karriere i Stevns?
            </h2>
