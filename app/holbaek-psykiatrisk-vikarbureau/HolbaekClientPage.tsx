...
export default function HolbaekClientPage() {
  ...
  const heroSlides = [
    {
      src: "/holbaek-hero-updated.png",
      alt: "Psykiatrisk Vikarbureau Holbæk - Nærværende, lyttende og forstående",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede psykiatriske vikarbureau i Holbæk og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både kommunale og private.",
    },
    {
      src: "/holbaek-image-2-updated.png",
      alt: "Tryghedspersonale der støtter ældre borger i Holbæk",
      title: "Nærværende, lyttende og forstående",
      subtitle:
        "Vores personale er uddannet til at håndtere komplekse borgerforløb med nærvær, empati og professionel forståelse. Det er netop i disse situationer, at det rigtige personale gør forskellen – og det er her, vi kommer ind i billedet.",
    },
    {
  ...
  const data = allCityInfo["holbaek-psykiatrisk-vikarbureau"] || allCityInfo["koege-psykiatrisk-vikarbureau"]
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Psykiatrisk Vikarbureau i Holbæk med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>psykiatrisk vikarbureau i Holbæk</strong> og omegn. Vi leverer fagligt stærke, erfarne og
                    omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både
                  ...
                  >
                    Vores personale er <strong>nærværende, lyttende og forstående</strong> i mødet med komplekse
                    borgerforløb, hvor adfærd kan være uforudsigelig, udadreagerende eller præget af demenssymptomer.
                    Det er netop i disse situationer, at det rigtige personale gør forskellen – og det er her, vi kommer
                    ind i billedet.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Holbæk by</strong>
                      </p>
                      <p>
                        • <strong>Odsherred Kommune</strong>
                      </p>
                      <p>
                        • <strong>Kalundborg</strong>
                      </p>
                      <p>
                        • <strong>Sorø</strong>
                      </p>
                      <p>
                        • <strong>Ringsted</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Holbæk Kommune og Region Sjælland</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/holbaek-psykiatrisk-vikar-caring.png"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt psykiatrisk vikarbureau i Holbæk og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i Holbæk</strong>, og vi har et stærkt netværk af dygtige
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Odsherred Kommune</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Kalundborg</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Sorø</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Ringsted</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Holbæk Kommune og Region Sjælland</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/holbaek-psykiatrisk-vikar-institutional.png"
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Holbæk, psykiatriske vikarer i Holbæk, vikar demens
              Holbæk, ekstern psykiatrisk støtte Holbæk, akut vikar psykiatri Sjælland, socialpsykiatrisk vikarbureau
              Holbæk, vikar til bosted i Odsherred, tryghedspersonale Kalundborg og Sorø, vikarbureau psykiatri Region
              Sjælland
            </p>
            <p>
              Vi dækker: Holbæk, Odsherred Kommune, Kalundborg, Sorø, Ringsted og øvrige dele af Holbæk Kommune og
              Region Sjælland
            </p>
          </div>
        </div>
