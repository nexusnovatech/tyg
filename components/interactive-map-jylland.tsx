...
// Sample location data for Jylland departments
const jyllandLocations: LocationData[] = [
  {
    id: "aarhus",
    city: "Aarhus",
    address: "Banegårdspladsen 16, 8000 Aarhus",
    coordinates: [10.2039, 56.1496], // Longitude, Latitude
  ...
  },
  {
    id: "kolding",
    city: "Kolding",
    address: "Jernbanegade 22, 6000 Kolding",
  ...
  },
  {
    id: "viborg",
    city: "Viborg",
    address: "Sct. Mathias Gade 68, 8800 Viborg",
    coordinates: [9.4026, 56.4489],
    services: allServices,
  },
  {
    id: "randers",
    city: "Randers",
    address: "Torvegade 14, 8900 Randers",
    coordinates: [10.036, 56.4607],
    services: allServices,
  },
  {
    id: "silkeborg",
    city: "Silkeborg",
    address: "Vestergade 25, 8600 Silkeborg",
    coordinates: [9.5499, 56.1697],
    services: allServices,
  },
]
...
function MapComponent({
  ...
  useEffect(() => {
    ...
    try {
      console.log("Initializing Jylland map...")
      ...
      const map = new mapboxgl.Map({
        ...
        center: [9.5, 56.2], // Center of Jylland
      ...
      resetViewButton.addEventListener("click", () => {
        ...
        jyllandLocations.forEach((location) => {
      ...
      map.on("load", () => {
        console.log("Jylland map loaded successfully")
        setIsLoading(false)
      ...
      if (activeLocation && mapInstanceRef.current) {
        ...
        markersRef.current.forEach((marker, index) => {
          ...
          if (jyllandLocations[index]?.id === activeLocation.id) {
