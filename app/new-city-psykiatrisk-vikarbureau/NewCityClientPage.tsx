...
export default function NewCityClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Psykiatrisk Vikarbureau [CITY NAME] - Nærværende, lyttende og forstående",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede psykiatriske vikarbureau i [CITY NAME] og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både kommunale og private.",
    },
    {
      src: "/placeholder.svg?height=600&width=800",
      alt: "Tryghedsmedarbejder der støtter ældre borger i [CITY NAME]",
    ...
    },
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i park i [CITY NAME]",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i [CITY NAME] Kommune og hele [REGION NAME]. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="[CITY NAME] & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i [CITY NAME]?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Psykiatrisk Vikarbureau i [CITY NAME] med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>psykiatrisk vikarbureau i [CITY NAME]</strong> og omegn. Vi leverer fagligt stærke, erfarne
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>[CITY NAME] by</strong>
                      </p>
                      <p>
                        • <strong>[NEARBY AREA 1]</strong>
                      </p>
                      <p>
                        • <strong>[NEARBY AREA 2]</strong>
                      </p>
                      <p>
                        • <strong>[NEARBY AREA 3]</strong>
                      </p>
                      <p>
                        • <strong>[NEARBY AREA 4]</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>[CITY NAME] Kommune og [REGION NAME]</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt psykiatrisk vikarbureau i [CITY NAME] og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i [CITY NAME]</strong>, og vi har et stærkt netværk af dygtige
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">[CITY NAME] by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">[NEARBY AREA 1]</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">[NEARBY AREA 2]</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">[NEARBY AREA 3]</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">[NEARBY AREA 4]</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af [CITY NAME] Kommune og [REGION NAME]</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i [CITY NAME] og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau [CITY NAME], psykiatriske vikarer i [CITY NAME], vikar
              demens [CITY NAME], ekstern psykiatrisk støtte [CITY NAME], akut vikar psykiatri [REGION NAME],
              socialpsykiatrisk vikarbureau [CITY NAME], vikar til bosted i [NEARBY AREA 1], tryghedspersonale [NEARBY
              AREA 2] og [NEARBY AREA 3], vikarbureau psykiatri [REGION NAME]
            </p>
            <p>
              Vi dækker: [CITY NAME], [NEARBY AREA 1], [NEARBY AREA 2], [NEARBY AREA 3], [NEARBY AREA 4] og øvrige dele
              af [CITY NAME] Kommune og [REGION NAME]
            </p>
          </div>
        </div>
      </section>
