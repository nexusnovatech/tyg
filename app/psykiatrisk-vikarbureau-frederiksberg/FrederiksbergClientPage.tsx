...
export default function FrederiksbergClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger på Frederiksberg",
      title: "Psykiatrisk vikarbureau med hjertet på rette sted",
      subtitle:
        "På Frederiksberg arbejder vi med borgere, der har psykiske og sociale behov. Vi tilbyder engagerede og fagligt kompetente vikarer, som ikke blot træder til ved behov, men som virkelig brænder for at gøre en forskel for både borgere og personale.",
    },
    {
      src: "/tryghedspersonale-aeldre-stoette.jpeg",
      alt: "Tryghedsmedarbejder der støtter ældre borger på Frederiksberg",
      title: "Når situationen kræver ekstra omsorg og erfaring",
      subtitle:
        "Indimellem kan personalet i socialpsykiatriske tilbud, plejecentre og botilbud på Frederiksberg møde borgere med komplekse og udfordrende adfærdsmønstre. I sådanne situationer er vores vikarer klar til at træde til med både faglig dygtighed og hjertet på rette sted.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park på Frederiksberg",
      title: "Lokal indsigt og hurtig tilgængelighed",
      subtitle:
        "Med vores placering i hovedstadsområdet har vi en god forståelse for Frederiksbergs særlige forhold og behov. Det betyder, at vi hurtigt kan stille kvalificeret personale til rådighed – uanset om det gælder indsats i byens centrum eller i de omkringliggende områder.",
    },
  ]
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Psykiatrisk vikarbureau på Frederiksberg med hjertet på rette sted
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    På Frederiksberg arbejder vi med borgere, der har psykiske og sociale behov. Hos
                    Tryghedspersonale.dk ved vi, hvor vigtigt det er at skabe tryghed og nærvær – især i en travl
                    hverdag, hvor udfordringer kan opstå pludseligt. Derfor tilbyder vi engagerede og fagligt kompetente
                    vikarer, som ikke blot træder til ved behov, men som virkelig brænder for at gøre en forskel for
                  ...
                  >
                    Vi ved, at hver borger har brug for en tryg og respektfuld tilgang, og at det tætte samarbejde med
                    det faste personale er afgørende for et godt resultat. Vores vikarer har både kompetencerne og
                    menneskeligheden til at håndtere disse situationer med ro og nærvær.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Vikarer med faglighed, empati og engagement
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Specialiseret erfaring med komplekse borgerforløb</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Professionel håndtering af udfordrende adfærd</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Deeskalering og konfliktløsning</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Relationelt og empatisk arbejde</strong>
                          <p className="text-gray-700 text-sm">Menneskeligt nærvær og forståelse</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker Frederiksberg</h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Frederiksberg centrum</p>
                      <p>• Frederiksberg Have området</p>
                      <p>• Østerbro grænse</p>
                      <p>• Vesterbro grænse</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/frederiksberg-image-1.png"
                        alt="Professionel psykiatrisk vikar på Frederiksberg - nærværende og forstående pleje"
                        fill
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Når situationen kræver ekstra omsorg og erfaring
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Indimellem kan personalet møde borgere med komplekse og udfordrende adfærdsmønstre
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Indimellem kan personalet i socialpsykiatriske tilbud, plejecentre og botilbud på Frederiksberg møde
                borgere med komplekse og udfordrende adfærdsmønstre. Samtidig kan der opstå perioder med akut
                personalemangel eller behov for midlertidig aflastning. I sådanne situationer er vores vikarer klar til
                at træde til med både faglig dygtighed og hjertet på rette sted.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                Vi ved, at hver borger har brug for en tryg og respektfuld tilgang, og at det tætte samarbejde med det
                faste personale er afgørende for et godt resultat. Vores vikarer har både kompetencerne og
                menneskeligheden til at håndtere disse situationer med ro og nærvær.
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Fleksible og tilpassede løsninger til Frederiksberg
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Akut hjælp ved personalemangel</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Planlagt støtte i ferieperioder eller ved spidsbelastninger
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Langvarig aflastning i komplekse plejeforløb</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Specialiserede løsninger til socialpsykiatriske og demensrelaterede tilbud
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/frederiksberg-hero.png"
                    alt="Professionel psykiatrisk vikar i varm samtale med ældre borger på Frederiksberg - nærværende og forstående pleje"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt Tryghedspersonale.dk for trygge og kompetente vikarer på Frederiksberg
            </h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Skal vi hjælpe jer med engagerede og nærværende vikarer? Kontakt os for en uforpligtende dialog om jeres
              behov.
            </p>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p className="text-green-600 font-semibold">
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Frederiksberg, vikarløsninger psykiatri Frederiksberg,
              demensvikar Frederiksberg, socialpsykiatrisk vikar Frederiksberg, vikar botilbud Frederiksberg, vikar §85
              §108 Frederiksberg, akut vikardækning Frederiksberg
            </p>
            <p>Vi dækker: Frederiksberg Kommune og tilstødende områder i hovedstadsområdet</p>
          </div>
        </div>
      </section>
    </div>
