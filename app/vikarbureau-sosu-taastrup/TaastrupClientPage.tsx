...
export default function TaastrupClientPage() {
  ...
  const heroSlides = [
    {
      src: "/koege-hero-updated.png",
      alt: "Vikarbureau SOSU Taastrup - Professionel pleje og omsorg",
      title: "SOSU-vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede vikarbureau SOSU i Taastrup og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde SOSU-assistenter og SOSU-hjælpere til plejehjem, hjemmepleje og hospitaler.",
    },
    {
      src: "/koege-image-2-updated.png",
      alt: "SOSU-vikar der støtter ældre borger i Taastrup",
      title: "Specialiseret i sundhed og pleje",
      subtitle:
        "Vores SOSU-personale er uddannet til at håndtere komplekse plejesituationer med professionalisme og empati. Det er netop i disse situationer, at det rigtige personale gør forskellen – og det er her, vi kommer ind i billedet.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "SOSU-medarbejder i samtale med borger i park i Taastrup",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, hjemmepleje, hospitaler og specialiserede plejeenheder i Høje-Taastrup Kommune og hele Region Hovedstaden. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  const services = [
    {
      ...
      description: "Erfarne SOSU-vikarer til plejehjem med ekspertise i demenspleje og omsorg for ældre borgere.",
      image:
    ...
    {
      title: "Vikar til hjemmepleje",
      subtitle: "Omsorg i eget hjem",
      description:
        "Vi tilbyder erfarne SOSU-vikarer til hjemmepleje med ekspertise i personlig pleje og praktisk hjælp.",
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/vikar-asylcenter-udrejsecenter-Le60NIU22xLcNFcyMQnRp5hYIwVHaD.png",
      link: "/ydelser/hjemmepleje",
    },
    {
      title: "Vikar til hospitaler",
      subtitle: "Sundhedsfaglig ekspertise",
      description: "Fagligt stærke SOSU-vikarer til hospitaler og sundhedsinstitutioner i hele regionen.",
      image:
      ...
      link: "/ydelser/hospitaler",
    },
    {
      title: "Vikar til botilbud",
      subtitle: "Specialiseret støtte",
      description: "Professionelle SOSU-vikarer til botilbud og specialiserede plejeenheder.",
      image:
    ...
    {
      title: "Vikar til demenspleje",
      subtitle: "Erfarne demensvikarer",
      description: "Erfarne SOSU-vikarer med specialisering i demenspleje og omsorg for demente borgere.",
      image:
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Taastrup & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et SOSU Vikarbureau i Taastrup?
              </h3>
            </div>
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <a href="tel:+4541443333" className="flex-1 sm:flex-none">
                <Button
                  variant="secondary"
                  className="bg-white text-red-600 hover:bg-gray-100 font-semibold px-6 py-3 rounded-full border-0 w-full sm:w-auto"
                >
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Vi tilbyder specialiserede SOSU-vikarer til forskellige områder inden for sundhed og pleje
            </p>
          </motion.div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Vikarbureau SOSU Taastrup med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>vikarbureau SOSU Taastrup</strong> og omegn. Vi leverer fagligt stærke, erfarne og
                    omsorgsfulde SOSU-assistenter og SOSU-hjælpere til plejehjem, hjemmepleje og hospitaler – både
                  ...
                  >
                    Taastrup er en aktiv by i Høje-Taastrup Kommune med plejecentre, hjemmeplejeordninger og
                    specialiserede sundhedstilbud. Vores personale er{" "}
                    <strong>uddannet til at håndtere komplekse plejesituationer</strong>, hvor professionalisme og
                    empati er afgørende. Det er netop i disse situationer, at det rigtige personale gør forskellen – og
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Specialister i sundhed og pleje
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Plejehjem</strong>
                          <p className="text-gray-700 text-sm">
                            Erfarne vikarer til demenspleje og omsorg for ældre borgere
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Hjemmepleje</strong>
                          <p className="text-gray-700 text-sm">Personlig pleje og praktisk hjælp i eget hjem</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Hospitaler</strong>
                          <p className="text-gray-700 text-sm">Sundhedsfaglig ekspertise til hospitaler og klinikker</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Botilbud og specialiserede plejeenheder</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-700 mt-6">
                      Vores vikarer er vant til at arbejde i både plejecentre, hjemmeplejeordninger, hospitaler og
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Taastrup by</strong>
                      </p>
                      <p>
                        • <strong>Høje-Taastrup</strong>
                      </p>
                      <p>
                        • <strong>Hedehusene</strong>
                      </p>
                      <p>
                        • <strong>Sengeløse</strong>
                      </p>
                      <p>
                        • <strong>Fløng</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Høje-Taastrup Kommune og Region Hovedstaden</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Samtidig ved vi, at pressede arbejdsmiljøer og komplekse plejesituationer kan slide på faste teams.
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Professionel håndtering af plejesituationer</span>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/sosu-taastrup-care-interaction.png"
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Aflastning ved sygdom og længerevarende fravær
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Det er ikke altid muligt at finde en hurtig løsning, når personale bliver syge eller har længerevarende
                fravær. Planlægning og rekruttering kan tage tid – men livet i jeres enhed skal stadig fungere.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Vi tilbyder <strong>midlertidig aflastning</strong>, hvor vores SOSU-vikarer varetager de konkrete
                opgaver – eller går ind som ekstra ressourcer i teamet, så det faste personale ikke bliver overbelastet.
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Midlertidig aflastning ved sygdom og fravær</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">
                      Specialiseret håndtering af komplekse plejesituationer
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Kontinuitet i plejen under rekrutteringsforløb</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    src="/koege-image-2-updated.png"
                    alt="SOSU-medarbejder der støtter ældre borger i Taastrup"
                    fill
      ...
      {/* Lokalt SOSU vikarbureau Section */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt SOSU vikarbureau i Taastrup og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i Taastrup</strong>, og vi har et stærkt netværk af dygtige
              SOSU-vikarer, der kender området og de kommunale arbejdsgange.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Taastrup by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
              ...
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Høje-Taastrup Kommune og Region Hovedstaden</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Menneskelighed i fokus – SOSU-vikarer med hjertet på det rette sted
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi kalder os ikke tryghedspersonale uden grund. Vores team består af nøje udvalgte SOSU-vikarer, som{" "}
              <strong>brænder for sundhed og pleje</strong> og som forstår, hvor vigtigt det er at bevare
              menneskeligheden – også i pressede situationer.
            </p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              className="mb-12"
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Fælles for vores SOSU-vikarer er</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Det sker i ny og næ, at en akut situation opstår, hvor det faste personale ikke længere kan håndtere
                situationen forsvarligt. Det kan fx skyldes:
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Pludseligt sygdomsfravær</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Akut behov for ekstra ressourcer</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Uforudsete plejesituationer</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Behov for specialiseret kompetence</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-200">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  I sådanne tilfælde kan det blive nødvendigt at <strong>få ekstern hjælp hurtigt på plads</strong> – og
                  her er vi klar til at rykke hurtigt ud. Vi <strong>stabiliserer situationen</strong>, skaber ro og
                  hjælper med at holde dagligdagen kørende, indtil en varig løsning er på plads.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Tryghedspersonale.dk - Når I har brug for akut hjælp - Ring 41 44 33 33"
                    fill
                    className="object-cover select-none pointer-events-none"
                    sizes="(max-width: 1024px) 100vw, 40vw"
                    draggable={false}
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Taastrup og omegn
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-xl">
                  <a href="tel:+4541443333" className="hover:underline transition-all duration-200">
                    41 44 33 33
                  </a>
                </p>
              </motion.div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> SOSU vikarbureau Taastrup, SOSU-vikarer i Taastrup, vikar plejehjem Taastrup,
              vikar hjemmepleje Taastrup, SOSU-assistenter Høje-Taastrup, vikarbureau sundhed Taastrup, vikar til
              hospital Taastrup, SOSU-hjælpere Taastrup, vikarbureau pleje Region Hovedstaden
            </p>
            <p>
              Vi dækker: Taastrup, Høje-Taastrup, Hedehusene, Sengeløse, Fløng og øvrige dele af Høje-Taastrup Kommune
