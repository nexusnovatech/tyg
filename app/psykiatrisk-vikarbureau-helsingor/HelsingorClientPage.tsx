...
export default function HelsingorClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Helsingør",
      title: "Specialiseret psykiatrisk vikarbemanding i Helsingør",
      subtitle:
        "Vi tilbyder kompetent og fleksibel psykiatrisk vikarbemanding til botilbud, plejecentre og socialpsykiatriske døgntilbud i hele Helsingør området. Vores vikarer er specialiseret i håndtering af komplekse psykiatriske, sociale og demensrelaterede udfordringer.",
    },
    {
      src: "/helsingor-hero.png",
      alt: "Psykiatrisk Vikarbureau Helsingør - professionel håndtering",
      title: "Eksperter i udfordrende adfærd",
      subtitle:
        "Vores personale er uddannet til at håndtere komplekse borgerforløb med udadreagerende adfærd, demensrelaterede problemstillinger og psykiatriske udfordringer. Vi skaber tryghed og stabilitet i pressede situationer.",
    },
    {
      src: "/helsingor-image-1.png",
      alt: "Tryghedsmedarbejder i varm samtale med ældre borger i Helsingør",
      title: "Lokal erfaring og faglighed",
      subtitle:
        "Vi har dyb indsigt i Helsingørs kommunale strukturer og tilpasser vores vikarydelser til jeres specifikke behov. Vores medarbejdere arbejder i respekt for eksisterende pædagogiske rammer og sikrer kontinuitet i borgerforløb.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Helsingør & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Helsingør?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Psykiatrisk Vikarbureau Helsingør
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    <strong>Tryghedspersonale.dk</strong> tilbyder specialiseret og kompetent psykiatrisk vikarbemanding
                    til botilbud, plejecentre, socialpsykiatriske døgntilbud samt §85- og §108-forløb i hele Helsingør
                    området. Vi leverer fleksible og fagligt stærke vikarer til institutioner, der arbejder med borgere
                    med komplekse psykiatriske, sociale og demensrelaterede udfordringer, når det faste personale
                    midlertidigt har brug for ekstra støtte.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    I Helsingør oplever botilbud og plejecentre ofte situationer, hvor borgernes behov overstiger det
                    faste personales kapacitet. Her træder <strong>Tryghedspersonale.dk</strong> til som en pålidelig og
                    fagligt kompetent samarbejdspartner, der sikrer ro, tryghed og kontinuitet i hverdagen for både
                    borgere, personale og ledelse.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Vores vikarydelser i Helsingør omfatter
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Håndtering af udfordrende adfærd</strong>
                          <p className="text-gray-700 text-sm">Udadreagerende og voldsom adfærd</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Demensrelaterede problemstillinger</strong>
                          <p className="text-gray-700 text-sm">Særligt tilrettelagte indsatser</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Midlertidig støtte i svære perioder</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Aflastning af personale</strong>
                          <p className="text-gray-700 text-sm">I socialpsykiatriske miljøer</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90 mb-4">
                      Vi er klar til at hjælpe med akut og planlagt vikarbemanding
                    </p>
                    <a href="tel:41443333">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker Helsingør og omegn</h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Helsingør centrum</p>
                      <p>• Espergærde</p>
                      <p>• Hornbæk</p>
                      <p>• Gilleleje</p>
                      <p>• Tikøb</p>
                      <p>• Øvrige dele af Helsingør Kommune</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/helsingor-image-1.png"
                        alt="Professionel psykiatrisk vikar i varm samtale med ældre borger i Helsingør"
                        fill
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi har dyb indsigt i Helsingørs kommunale strukturer og de særlige krav, der stilles til psykiatrisk og
                socialpædagogisk arbejde i området. Vores vikarydelser tilpasses altid jeres specifikke behov og
                arbejder i respekt for eksisterende pædagogiske rammer.
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Vores medarbejdere i Helsingør
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Har relevant uddannelse som social- og sundhedsassistenter, pædagoger eller tilsvarende erfaring
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Er trænet i konflikthåndtering, low arousal metoder og relationelt arbejde
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Arbejder med respekt for borgerens individuelle behov og ressourcer
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Indgår som støtte i eksisterende teams uden at overtage styringen
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/helsingor-image-1.png"
                    alt="Professionel psykiatrisk vikar i varm samtale med ældre borger - nærværende og forstående pleje i Helsingør"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Helsingør og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Helsingør, psykiatrisk vikar Helsingør, vikarbemanding
              botilbud Helsingør, demensvikar Helsingør, socialpsykiatrisk vikar Helsingør, vikardækning §85 Helsingør,
              psykiatrisk støtte Helsingør
            </p>
            <p>Vi dækker: Helsingør, Espergærde, Hornbæk, Gilleleje, Tikøb og øvrige dele af Helsingør Kommune</p>
          </div>
        </div>
      </section>
    </div>
