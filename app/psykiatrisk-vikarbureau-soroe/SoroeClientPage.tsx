...
export default function SoroeClientPage() {
  ...
  const heroSlides = [
    {
      src: "/soroe-hero.png",
      alt: "Psykiatrisk Vikarbureau Sorø - Specialiseret i komplekse borgerforløb",
      title: "Professionelt vikarbistand til psykiatri og socialpædagogik",
      subtitle:
        "Tryghedspersonale.dk leverer kompetente og erfarne vikarer til psykiatriske institutioner, bosteder og plejehjem i Sorø Kommune. Vi specialiserer os i komplekse borgerforløb og akut støtte, hvor faglighed og empati går hånd i hånd.",
    },
    {
      src: "/soroe-hero.png",
      alt: "Tryghedsmedarbejder der støtter ældre borger i Sorø",
      title: "Når komplekse behov kræver specialiseret hjælp",
      subtitle:
        "Vores vikarer er specialiserede i at håndtere borgere med psykiske lidelser, demens og udadreagerende adfærd. Vi tilbyder både planlagte vikarløsninger og akut udrykning til situationer, der kræver øjeblikkelig professionel støtte.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Sorø",
      title: "Lokalt kendskab og hurtig responstid",
      subtitle:
        "Med vores dybe kendskab til Sorø Kommune og omegn kan vi levere målrettede vikarløsninger, der matcher jeres specifikke behov. Vi er tilgængelige alle ugens dage og kan reagere hurtigt på akutte situationer.",
    },
  ]
  ...
  const data = allCityInfo["soroe-psykiatrisk-vikarbureau"]

  return (
    <div className="min-h-screen">
      {/* Enhanced Hero Section */}
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Sorø & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Sorø?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Din lokale psykiatriske vikarløsning i Sorø
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Hos <strong>Tryghedspersonale.dk</strong> ved vi, hvor vigtigt det er at have stabile og kompetente
                    vikarer til psykiatri og socialpædagogiske opgaver i <strong>Sorø Kommune</strong>. Vores vikarer
                    kombinerer faglighed med empati og har stor erfaring med at støtte borgere med psykiske lidelser,
                    demens og komplekse sociale udfordringer.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi tilbyder fleksible løsninger til bosteder, plejehjem, socialpsykiatriske enheder og akut opståede
                    situationer, hvor tryghed og stabilitet skal være i højsædet. Vores kendskab til Sorøs lokale
                    forhold og institutioner gør os til en pålidelig samarbejdspartner for både offentlige og private
                    aktører.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Vores kernekompetencer i Sorø Kommune
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Psykiatrisk støtte og omsorg</strong>
                          <p className="text-gray-700 text-sm">
                            Komplekse psykiatriske diagnoser som skizofreni, bipolar lidelse, PTSD, angst og
                      ...
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Demenspleje med fokus på ro og tryghed</strong>
                          <p className="text-gray-700 text-sm">
                            Specialiserede vikarer til demensafsnit og udadreagerende borgere
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            Børn, unge og voksne med autisme, ADHD, tilknytningsforstyrrelser og udviklingsforstyrrelser
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Akut og midlertidig vikarhjælp</strong>
                          <p className="text-gray-700 text-sm">Robuste vikarer til kriser og akut behov</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Sorø by</strong>
                      </p>
                      <p>
                        • <strong>Stenlille</strong>
                      </p>
                      <p>
                        • <strong>Dianalund</strong>
                      </p>
                      <p>
                        • <strong>Ruds Vedby</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Sorø Kommune og Region Sjælland</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Hvorfor vælge Tryghedspersonale.dk i Sorø?
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              At arbejde med borgere med psykiske og sociale udfordringer kræver ikke bare faglig viden, men også stor
              menneskelig indsigt
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                At arbejde med borgere med psykiske og sociale udfordringer kræver ikke bare faglig viden, men også stor
                menneskelig indsigt. Vores vikarer i Sorø er nøje udvalgt for deres evne til at skabe trygge rammer,
                håndtere udfordrende adfærd og indgå i konstruktive relationer med både borgere og personale.
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">Hurtig og effektiv responstid</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Fleksible vikarordninger, der matcher jeres behov</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Vikarer med solid uddannelse og relevant erfaring</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Fokus på konfliktnedtrapning og deeskalering</span>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Midlertidig aflastning ved visitation og længerevarende sagsforløb
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Hvis sagsbehandling, visitation eller udredning trækker ud, kan vores vikarer sikre kontinuitet og
                støtte i ventetiden. Vi aflaster det faste personale og sikrer, at borgerne får den nødvendige omsorg.
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Når udfordringer kræver ekstra hænder
                </h3>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  I Sorø oplever vi ofte, at udfordrende adfærd kan presse personalet til grænsen. Det kan være i form
                  af:
                </p>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Voldsom uro eller trusler mod personale</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Psykiske sammenbrud og kriser</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Pludselige akutte situationer</span>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokal tilstedeværelse og kendskab til Sorø
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi kender Sorø og omegn, og vores lokale erfaring betyder, at vi hurtigt kan tilbyde vikarer, som er
              fortrolige med de særlige behov og arbejdsgange i kommunen.
            </p>
          </motion.div>
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Sorø by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Stenlille</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Dianalund</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Ruds Vedby</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Sorø Kommune og Region Sjælland</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Vikarer med engagement, faglighed og hjertet på rette sted
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi tror på, at den bedste støtte skabes gennem tillid og forståelse – det er kernen i vores vikarers
              arbejde.
            </p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              className="mb-12"
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Vores vikarer er</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">
                        Uddannet inden for psykiatri, pædagogik eller sundhed
                      </h4>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">
                        Erfaren i at håndtere akutte og komplekse borgerforløb
                      </h4>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">
                        Kompetente i konflikthåndtering og deeskalering
                      </h4>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">
                        Empatiske og stabile med fokus på relationsarbejde
                      </h4>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi tilbyder hurtigt vikarer, der er specialiserede i at skabe ro, tryghed og struktur, selv i de mest
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt Tryghedspersonale.dk for psykiatrisk vikarhjælp i Sorø
            </h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Har I akut behov for ekstra hænder eller ønsker I at sikre jer en stabil vikarordning? Vi er klar til at
              hjælpe med kompetente vikarer, der kan gøre en forskel.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-xl">Alle ugens dage – også i weekender og på helligdage</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-green-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-green-700 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Sorø, vikar psykiatri Sorø Kommune, socialpsykiatrisk
              vikar Sorø, akut vikar demens Sorø, vikarbureau til bosted Sorø, psykiatrisk støtte Sorø by
            </p>
            <p>
              Vi dækker: Sorø by, Stenlille, Dianalund, Ruds Vedby og øvrige dele af Sorø Kommune og Region Sjælland
            </p>
          </div>
        </div>
      </section>
