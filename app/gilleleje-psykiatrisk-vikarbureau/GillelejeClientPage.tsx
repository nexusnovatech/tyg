...
export default function GillelejeClientPage() {
  ...
  const heroSlides = [
    {
      src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Q8FuexYH0tDaTQyUDpBQLSjcfngZHA.png",
      alt: "Psykiatrisk Vikarbureau Gilleleje - Nærværende, lyttende og forstående",
      title: "Vikarer med hjertet på det rette sted",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit lokale og specialiserede psykiatriske vikarbureau i Gilleleje og omegn. Vi leverer fagligt stærke, erfarne og omsorgsfulde vikarer til socialpsykiatrien, demenspleje og specialpædagogiske tilbud – både kommunale og private.",
    },
    {
      src: "/gilleleje-image-2-updated.png",
    ...
    },
    {
      ...
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Gribskov Kommune og hele Region Hovedstaden. Vores mål er at være jeres pålidelige partner.",
    },
  ]
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Psykiatrisk Vikarbureau i Gilleleje med vikarer med hjertet på det rette sted
              </h2>
            </motion.div>
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    ...
                    <strong>psykiatriske vikarbureau i Gilleleje</strong> og omegn. Vi leverer fagligt stærke, erfarne
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Gilleleje by</strong>
                      </p>
                      <p>
                        • <strong>Dronningmølle</strong>
                      </p>
                      <p>
                        • <strong>Hornbæk</strong>
                      </p>
                      <p>
                        • <strong>Esrum</strong>
                      </p>
                      <p>
                        • <strong>Græsted</strong>
                      </p>
                      <p>
                        • Samt øvrige dele af <strong>Gribskov Kommune og Region Hovedstaden</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/gilleleje-psykiatrisk-vikar-caring.png"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt psykiatrisk vikarbureau i Gilleleje og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i Gilleleje</strong>, og vi har et stærkt netværk af dygtige
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Gilleleje by</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Dronningmølle</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Hornbæk</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Esrum</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Græsted</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Gribskov Kommune og Region Hovedstaden</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/gilleleje-psykiatrisk-vikar-institutional.png"
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Gilleleje, psykiatriske vikarer i Gilleleje, vikar
              demens Gilleleje, ekstern psykiatrisk støtte Gilleleje, akut vikar psykiatri Hovedstaden,
              socialpsykiatrisk vikarbureau Gilleleje, vikar til bosted i Dronningmølle, tryghedspersonale Hornbæk og
              Esrum, vikarbureau psykiatri Region Hovedstaden
            </p>
            <p>
              Vi dækker: Gilleleje, Dronningmølle, Hornbæk, Esrum, Græsted og øvrige dele af Gribskov Kommune og Region
              Hovedstaden
            </p>
          </div>
        </div>
