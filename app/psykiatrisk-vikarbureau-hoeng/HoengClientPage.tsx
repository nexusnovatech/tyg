...
export default function HoengClientPage() {
  ...
  const heroSlides = [
    {
      src: "/hoeng-hero.png",
      alt: "Psykiatrisk Vikarbureau Høng - Specialiseret i komplekse borgerforløb",
      title: "Specialiseret i komplekse borgerforløb",
      subtitle:
        "I Høng ved vi, at arbejdet med borgere med komplekse psykiske, sociale og adfærdsmæssige udfordringer kræver særlig faglighed, erfaring og nærvær. Vores vikarer kan håndtere udadreagerende adfærd og skabe trygge rammer.",
    },
    {
      src: "/tryghedspersonale-aeldre-stoette.jpeg",
      alt: "Tryghedsmedarbejder der støtter ældre borger i Høng",
      title: "Erfarne psykiatriske vikarer",
      subtitle:
        "Som psykiatrisk vikarbureau i Høng forstår vi de særlige udfordringer ved komplekse borgerforløb. Vores vikarer har omfattende erfaring med psykiske lidelser, demens og adfærdsudfordringer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i Høng",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til psykiatriske institutioner, demensafsnit og socialpædagogiske tilbud i Høng Kommune og omegn.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Høng & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Høng?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Din lokale partner i Høng til komplekse borgerforløb og psykiatrisk støtte
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    I <strong>Høng</strong> ved vi, at arbejdet med borgere, som har komplekse psykiske, sociale og
                    adfærdsmæssige udfordringer, kræver særlig faglighed, erfaring og nærvær. Hos{" "}
                    <strong>Tryghedspersonale.dk</strong> tilbyder vi specialiserede psykiatriske og socialpædagogiske
                    vikarer, som kan træde til ved behov og skabe trygge rammer for både borgere og personale.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi har stor erfaring med at levere vikarer, der kan håndtere <strong>komplekse borgerforløb</strong>
                    , hvor psykisk sygdom, demens, adfærdsudfordringer og sociale vanskeligheder ofte overlapper og
                    kræver en helhedsorienteret tilgang.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Vikarer med fokus på komplekse borgerforløb
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Uddannede og erfarne</strong>
                          <p className="text-gray-700 text-sm">i psykiatri, socialpædagogik og demenspleje</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Indgående kendskab</strong>
                          <p className="text-gray-700 text-sm">til psykiske lidelser som skizofreni, PTSD og angst</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Professionel håndtering</strong>
                          <p className="text-gray-700 text-sm">af udadreagerende og voldsom adfærd</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Skaber relationer</strong>
                          <p className="text-gray-700 text-sm">og tillid i svære og uforudsigelige situationer</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90 mb-4">Vi er klar til at hjælpe med akut vikarhjælp i Høng</p>
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker Høng og omegn</h3>
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/hoeng-hero.png"
                        alt="Psykiatrisk vikar i Høng - specialiseret i komplekse borgerforløb"
                        fill
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">Vores ydelser i Høng Kommune</h2>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">
                      <strong>Psykiatriske institutioner og bosteder</strong>
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Demensafsnit</strong> med fokus på borgere med svær og kompleks demens
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Socialpædagogiske tilbud</strong> for børn, unge og voksne med udviklingsforstyrrelser
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      <strong>Akut og midlertidig indsats</strong> ved kriser og forbigående personalemangel
                    </span>
                  </div>
                </div>
              </div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Vi arbejder tæt sammen med kommunale og private enheder i Høng og området omkring for at sikre, at
                vikaren passer til den konkrete opgave og borgerens behov.
              </p>
      ...
      <section id="kontakt" className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Kontakt os for psykiatrisk vikarhjælp i Høng</h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Har I akut brug for professionel støtte, eller ønsker I at planlægge langsigtet vikarassistance i Høng? Vi
              står klar med kvalificerede vikarer, som kan gøre en forskel.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-xl">Hele året - også weekender og ferier</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p className="text-green-700 font-semibold">
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Høng, vikar til komplekse borgerforløb Høng,
              socialpsykiatrisk vikar Høng Kommune, akut psykiatri vikar Høng, vikarbureau bosted Høng, støtte til
              demens Høng
            </p>
            <p>Vi dækker: Høng, Kalundborg Kommune, Holbæk Kommune, Sorø Kommune og øvrige dele af Region Sjælland</p>
          </div>
        </div>
      </section>
    </div>
