...
export default function HorsholmClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Hørsholm",
      title: "Specialiseret i komplekse borgerforløb",
      subtitle:
        "Vores personale er uddannet til at håndtere komplekse borgerforløb i Hørsholm, hvor adfærd kan være uforudsigelig, udadreagerende eller præget af psykiske udfordringer. Det er netop i disse situationer, at det rigtige personale gør forskellen – og det er her, vi kommer ind i billedet.",
    },
    {
      src: "/horsholm-hero.png",
      alt: "Psykiatrisk Vikarbureau Hørsholm - Specialiseret i komplekse borgerforløb",
      title: "Psykiatrisk vikarbureau i Hørsholm",
      subtitle:
        "Som specialiseret psykiatrisk vikarbureau i Hørsholm forstår vi de særlige udfordringer, der opstår i arbejdet med borgere med psykiske lidelser, demens og udviklingsforstyrrelser. Vores vikarer har omfattende erfaring med at skabe trygge rammer og professionelle relationer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Hørsholm",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger og støtteordninger i Hørsholm Kommune og omegn. Vores mål er at være jeres pålidelige partner i alle situationer.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Hørsholm & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Hørsholm?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Psykiatrisk Vikarbureau Hørsholm
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Tryghedspersonale.dk er et specialiseret psykiatrisk vikarbureau i Hørsholm, der tilbyder kompetent
                    og fleksibel vikardækning til botilbud, døgntilbud, plejehjem og støtteordninger i Hørsholm Kommune
                    og omegn. Vi træder til med fagligt stærke medarbejdere, når der er behov for midlertidig, akut
                    eller længerevarende bemanding i psykiatriske eller socialpædagogiske miljøer.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi arbejder med respekt for faglige mål og borgernes trivsel – og vi påtager os kun opgaver, som vi
                    har kapacitet og faglighed til at løfte professionelt og ansvarligt. Vores tilgang er kendetegnet
                    ved stabilitet, tryghed og høj faglig etik.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Når behovet overstiger jeres ressourcer
                    </h3>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            Konfliktnedtrappende kompetencer og low arousal-pædagogik
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Psykiske kriser</strong>
                          <p className="text-gray-700 text-sm">Erfaring med psykotiske forløb og affektudbrud</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Sygdom og vakancer</strong>
                          <p className="text-gray-700 text-sm">Kontinuitet i borgerens hverdag</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Midlertidig øget støtte og udredning</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker hele Hørsholm Kommune</h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Centrale Hørsholm</p>
                      <p>• Rudersdal og Fredensborg</p>
                      <p>• Socialpsykiatriske botilbud</p>
                      <p>• Plejecentre og demensafsnit</p>
                      <p>• §107 og §108-tilbud</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/horsholm-hero.png"
                    alt="Professionel psykiatrisk vikar i varm samtale med ældre borger - nærværende og forstående pleje i Hørsholm"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Hørsholm og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Hørsholm, vikar psykiatri Hørsholm, socialpsykiatrisk
              vikar Hørsholm, vikarbemanding botilbud Hørsholm, §108 vikarydelser Hørsholm, vikar ved udadreagerende
              adfærd Hørsholm, vikar ved psykotiske episoder, akut vikar demens Hørsholm, psykiatrisk vikar Sjælland,
              vikarbureau plejecenter Hørsholm
            </p>
            <p>Vi dækker: Hørsholm, Rudersdal, Fredensborg og øvrige dele af Hørsholm Kommune og omegn</p>
          </div>
        </div>
      </section>
    </div>
