...
export default function HerlevClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Herlev",
    ...
    },
    {
      ...
      alt: "Tryghedsmedarbejder der støtter ældre borger i Herlev",
      title: "Specialiseret i socialpsykiatri",
      subtitle:
        "Som psykiatrisk vikarbureau i Herlev forstår vi de særlige udfordringer, der opstår i arbejdet med borgere med psykiske lidelser, demens og udviklingsforstyrrelser. Vores vikarer har omfattende erfaring med at skabe trygge rammer og professionelle relationer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Herlev",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Herlev Kommune og hele Region Hovedstaden. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Herlev & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Herlev?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Psykiatrisk Vikarbureau i Herlev
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Tryghedspersonale.dk tilbyder specialiseret bemanding til botilbud, bosteder, plejecentre og
                    socialpsykiatriske tilbud i Herlev. Vi træder til med fagligt stærke og menneskeligt solide vikarer,
                    når der er behov for akut, midlertidig eller længerevarende vikardækning – særligt i forbindelse med
                    komplekse psykiatriske forløb, udadreagerende borgere og pressede situationer.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi kender til det pres, som kan opstå i psykiatriske og socialpædagogiske miljøer, og vi hjælper
                    netop dér, hvor der mangler hænder og ro. Vi tilbyder vikardækning, der både stabiliserer og
                    aflaster – uden at overtage, men med fokus på at understøtte det faste personale og skabe
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Når hverdagen bliver udfordret
                    </h3>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            hvor ekstra personale er nødvendigt for at skabe sikkerhed
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Ved forflytning eller afklaring</strong>
                          <p className="text-gray-700 text-sm">hvor der kræves støtte til en overgangsperiode</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">fx grundet sygdom, ferie eller ubesatte stillinger</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Ved uro i en beboergruppe</strong>
                          <p className="text-gray-700 text-sm">som skaber usikkerhed blandt øvrige borgere</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">
                      Vi dækker hele Herlev og nærliggende områder
                    </h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Herlev bymidte og omegn</p>
                      <p>• Hjortespring og Lindehøj</p>
                      <p>• Nærliggende bydele som Gladsaxe, Ballerup og Husum</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/herlev-hero.png"
                        alt="Psykiatrisk Vikarbureau Herlev - Specialiseret i komplekse borgerforløb"
                        fill
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Vores personale – fagligt klædt på og relationelt stærkt
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vores vikarer har stor erfaring med psykiatriske og socialpædagogiske opgaver – og kan træde direkte ind
                i arbejdet, både fagligt og menneskeligt.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                De er pædagoger, social- og sundhedsassistenter eller medarbejdere med relevant specialiseret praksis,
                vante i at arbejde med low arousal, konflikthåndtering og ro-skabende metoder.
              </p>
              <div className="bg-gradient-to-r from-red-50 to rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Erfarne med psykiatriske diagnoser, dobbeltdiagnoser og udadreagerende adfærd
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Velfunderede i dokumentation og samarbejde med tværfaglige teams
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Relationskompetente og respektfulde i mødet med den enkelte borger
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi tilbyder hurtig og fleksibel vikardækning i Herlev og omegn
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Herlev bymidte og omegn</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Hjortespring og Lindehøj</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Gladsaxe</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Ballerup og Husum</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>
                    Vores kendskab til området betyder, at vi kan handle hurtigt – både ved planlagt vikardækning og ved
                    akutte behov, fx aften/nat/weekend.
                  </strong>
                </p>
              </div>
            </motion.div>
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Eksempler på vikarydelser i Herlev</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">Vi stiller med personale til:</p>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">§85-støtte</strong>
                    <p className="text-gray-700">hvor borgere har øget behov for struktur og guidning</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    ...
                    <p className="text-gray-700">
                      hvor borgerne har svære psykiatriske lidelser og kræver høj faglig indsats
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">hvor tryghed og genkendelighed er centrale værdier</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Ungeområdet</strong>
                    <p className="text-gray-700">
                      hvor psykosociale udfordringer og mistrivsel kræver særlig pædagogisk tilgang
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">Tillidsfuldt samarbejde</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi arbejder med forståelse for kommunale og institutionelle behov – og ved, at fleksibilitet og faglighed
              går hånd i hånd
            </p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              className="mb-12"
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Vi tilbyder</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Akut udrykning</h4>
                      <p className="text-gray-700">og dag-til-dag-dækning</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Planlagt ferie- og sygdomsdækning</h4>
                      <p className="text-gray-700">med erfarne vikarer</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Længerevarende støtte</h4>
                      <p className="text-gray-700">i komplicerede forløb</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Tæt sparring med ledelsen</h4>
                      <p className="text-gray-700">så indsatsen matcher den pædagogiske retning og borgernes behov</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100 inline-block">
                <p className="text-xl text-gray-700 leading-relaxed font-medium max-w-3xl">
                  <strong>Vi går ikke bare ind og tager en vagt</strong> – vi går ind og gør en forskel.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-xl font-semibold mb-8 text-gray-800">
                Vi har særlig erfaring med borgere, der udviser kompleks og udadreagerende adfærd
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Voldsom udadreagerende adfærd</strong> hvor ekstra personale er nødvendigt for at skabe
                    sikkerhed
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Demens med psykotiske træk</strong> eller aggressivitet som kræver specialiseret tilgang
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Uro eller psykisk ustabilitet</strong> hos borgeren som påvirker hele miljøet
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Risiko for selvskade eller skade på andre</strong> som kræver øjeblikkelig handling
                  </p>
                </div>
              </div>
              <p className="text-gray-700 mt-8 text-lg leading-relaxed">
                I sådanne tilfælde stabiliserer vi situationen, skaber ro og hjælper med at håndtere krisen korrekt,
            ...
            >
              ...
              <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                Når en borgers adfærd bliver så udfordrende, at det faste personale ikke længere kan håndtere
                situationen forsvarligt, er vi klar til at rykke hurtigt ud.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                Vi stabiliserer situationen, skaber ro og hjælper med at håndtere krisen korrekt, indtil en varig
                løsning er på plads. Vores mål er at skabe tryghed for både borgere og personale.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Herlev og omegn
            </h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Er du leder eller koordinator i Herlev og har behov for midlertidig faglig støtte? Kontakt os i dag, og
              lad os tage en uforpligtende snak om, hvordan vi kan hjælpe jer videre – hurtigt og professionelt.
            </p>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center" style={{ backgroundColor: "#e9f8ee", padding: "20px", borderRadius: "5px" }}>
            <p style={{ color: "#127035", margin: 0 }}>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Herlev, vikar ved udadreagerende adfærd Herlev,
              vikardækning bosteder Herlev, demensvikar Herlev, socialpsykiatrisk vikar Herlev, §85 og §108 vikarydelser
              Herlev
            </p>
          </div>
        </div>
