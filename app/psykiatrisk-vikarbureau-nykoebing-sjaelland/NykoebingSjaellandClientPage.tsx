...
export default function NykoebingSjaellandClientPage() {
  ...
  const heroSlides = [
    {
      src: "/nykoebing-sjaelland-hero.png",
      alt: "Psykiatrisk Vikarbureau Nykøbing Sjælland - Specialiseret i komplekse borgerforløb",
      title: "Ekspertvikarer til psykiatri og socialpædagogik",
      subtitle:
        "Velkommen til Tryghedspersonale.dk, dit specialiserede psykiatriske vikarbureau i Nykøbing Sjælland og hele Odsherred Kommune. Vi leverer erfarne psykiatriske vikarer, som kan håndtere komplekse borgerforløb med omsorg, professionalisme og stor menneskelig indsigt.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i Nykøbing Sjælland",
      title: "Fokus på komplekse borgerforløb",
      subtitle:
        "Vores vikarer arbejder målrettet med borgere, der har psykiske lidelser, demens med udadreagerende adfærd eller komplekse sociale udfordringer, hvor stabilitet og ro er altafgørende.",
    },
    {
      src: "/koege-psykiatrisk-vikar-caring.png",
      alt: "Professionel psykiatrisk vikar i varm samtale med ældre borger",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi støtter bosteder, plejehjem, socialpsykiatriske tilbud og akutberedskab med fleksible og kompetente vikarer i Nykøbing Sjælland og hele Odsherred Kommune.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Nykøbing Sjælland & Odsherred" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Nykøbing Sjælland?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Ekspertvikarer til psykiatri og socialpædagogik i Nykøbing Sjælland
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    I <strong>Nykøbing Sjælland</strong> og hele <strong>Odsherred Kommune</strong> leverer{" "}
                    <strong>Tryghedspersonale.dk</strong> erfarne psykiatriske vikarer, som kan håndtere komplekse
                    borgerforløb med omsorg, professionalisme og stor menneskelig indsigt. Vi støtter bosteder,
                    plejehjem, socialpsykiatriske tilbud og akutberedskab med fleksible og kompetente vikarer.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vores vikarer arbejder målrettet med borgere, der har psykiske lidelser, demens med udadreagerende
                    adfærd eller komplekse sociale udfordringer, hvor stabilitet og ro er altafgørende.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Fokus på komplekse borgerforløb – din tryghed i svære situationer
                    </h3>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            skizofreni, bipolar lidelse, PTSD og personlighedsforstyrrelser
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Demens med udadreagerende adfærd</strong>
                          <p className="text-gray-700 text-sm">trænet i omsorg og sikkerhed</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Socialpædagogisk arbejde</strong>
                          <p className="text-gray-700 text-sm">
                            med mennesker med autisme, ADHD og andre udviklingsforstyrrelser
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Akutte og krisesituationer</strong>
                          <p className="text-gray-700 text-sm">håndteret med ro og faglighed</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-700 mt-6">
                      Vores vikarer bidrager til at skabe et trygt og stabilt miljø, hvor både borgere og personale
                      oplever støtte og respekt.
                    </p>
                  </motion.div>
                </div>
              </div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>
                        • <strong>Nykøbing Sjælland</strong>
                      </p>
                      <p>
                        • <strong>Høng</strong>
                      </p>
                      <p>
                        • <strong>Gørlev</strong>
                      </p>
                      <p>
                      ...
                      <p>
                        • Samt øvrige dele af <strong>Odsherred Kommune</strong>
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokal tilstedeværelse i Nykøbing Sjælland og Odsherred
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi kender de særlige behov og arbejdsgange i Nykøbing Sjælland og Odsherred Kommune
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi kender de særlige behov og arbejdsgange i Nykøbing Sjælland og Odsherred Kommune. Vores vikarer er
                derfor altid hurtigt på plads og klar til at hjælpe på blandt andet:
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">Bosteder og plejecentre i Nykøbing Sjælland</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Socialpsykiatriske tilbud i kommunen</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Akutindsatser ved kriser og komplekse forløb</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Midlertidig støtte til faste teams under visitation og udredning
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-200">
                <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Fleksibel vikarhjælp til alle behov
                </h3>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Uanset om I har akut brug for ekstra hænder eller planlægger længerevarende aflastning, kan vi
                  tilbyde:
                </p>
                <div className="space-y-3">
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <span className="text-gray-700">Hurtig udrykning ved pludselige behov</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <span className="text-gray-700">Vikarer med solid erfaring og empati</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <span className="text-gray-700">
                      Støtte i komplekse borgerforløb, hvor kontinuitet er afgørende
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <span className="text-gray-700">Omsorgsfuld hjælp til borgere med udfordrende adfærd</span>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Tryghedspersonale.dk – Vikarer med faglighed og hjerte
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi vægter både uddannelse, erfaring og personlighed højt, når vi udvælger vores vikarer. De er kendt
                for:
              </p>
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">At kunne håndtere komplekse og akutte situationer</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      At skabe tillidsfulde relationer til borgere og personale
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      At arbejde selvstændigt og samtidig være samarbejdsvillige
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      At mestre konfliktnedtrapning og deeskaleringsteknikker
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    ...
                    alt="Tryghedsmedarbejder der støtter ældre borger i Nykøbing Sjælland"
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalt psykiatrisk vikarbureau i Nykøbing Sjælland og nærområderne
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Tryghedspersonale.dk er <strong>forankret i Nykøbing Sjælland</strong>, og vi har et stærkt netværk af
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Nykøbing Sjælland</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                    ...
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Gørlev</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Ubby</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Samt øvrige dele af Odsherred Kommune</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os for psykiatrisk vikarbistand i Nykøbing Sjælland
            </h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Har I brug for en erfaren og stabil vikar til at håndtere komplekse borgerforløb eller akut behov? Kontakt
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Nykøbing Sjælland, vikar psykiatri Odsherred Kommune,
              socialpsykiatrisk vikar Nykøbing Sjælland, vikar demens Nykøbing Sjælland, vikarbureau til bosted Nykøbing
              Sjælland, støtte til komplekse borgerforløb Nykøbing Sjælland
            </p>
            <p>
              Vi dækker: Nykøbing Sjælland, Høng, Gørlev, Ruds Vedby, Ubby, Jerslev, Svebølle, Viskinge og øvrige dele
