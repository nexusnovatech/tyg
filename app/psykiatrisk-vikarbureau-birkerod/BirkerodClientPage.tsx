...
export default function BirkerodClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Birkerød",
    ...
    },
    {
      ...
      alt: "Tryghedsmedarbejder der støtter ældre borger i Birkerød",
      title: "Specialiseret i socialpsykiatri",
      subtitle:
        "Som psykiatrisk vikarbureau i Birkerød forstår vi de særlige udfordringer, der opstår i arbejdet med borgere med psykiske lidelser, demens og udviklingsforstyrrelser. Vores vikarer har omfattende erfaring med at skabe trygge rammer og professionelle relationer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Birkerød",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Birkerød og hele Rudersdal Kommune. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Birkerød & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Birkerød?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Psykiatrisk Vikarbureau i Birkerød
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    <strong>Tryghedspersonale.dk</strong> leverer erfarne, relationsstærke og specialiserede vikarer til
                    botilbud, døgntilbud, plejecentre og socialpsykiatriske tilbud i{" "}
                    <strong>Birkerød og hele Rudersdal Kommune</strong>. Vores vikarer træder til med både nærvær og
                    faglighed – især i komplekse forløb, hvor borgere udviser udadreagerende eller selvskadende adfærd,
                    eller hvor der er tale om dobbeltdiagnoser og lavt funktionsniveau.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi hjælper både ved planlagte fravær og i akutte situationer, hvor personalet står under pres. Vi
                    arbejder altid med respekt for den eksisterende faglige linje og med fokus på at skabe tryghed – for
                    både borgere og personale.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Vi er specialister i psykiatri og socialpædagogisk støtte
                    </h3>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            hvor konfliktnedtrapning og lav-arousal er nødvendige redskaber
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            som kræver konstant tilstedeværelse og emotionel afstemning
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            hvor psykiatriske lidelser kombineres med misbrug eller kognitive vanskeligheder
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Demens og utryghedstilstande</strong>
                          <p className="text-gray-700 text-sm">hvor ro, tydelighed og genkendelighed er centralt</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90 mb-4">Vi er klar til at hjælpe jer i Birkerød</p>
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/birkerod-hero.png"
                        alt="Psykiatrisk vikar i Birkerød - professionel omsorg og støtte"
                        fill
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                    Vi træder til, når behovet overstiger kapaciteten
                  </h2>
                </div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Mange af vores samarbejdspartnere i Birkerød og omegn har brug for støtte i perioder præget af
                personalemangel, sygdom eller barsel.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                I disse situationer stiller vi med vikarer, der kan bidrage fra første vagt – og som skaber ro og
                struktur, selv i kaotiske situationer.
              </p>
              <div className="bg-gradient-to-r from-red-50 to rose-50 p-8 rounded-2xl border border-red-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <div className="w-2 h-8 bg-red-500 rounded-full mr-4"></div>
                  Situationer hvor vi hjælper
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Personalemangel, sygdom eller barsel</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Øgede konfliktniveauer i borgergruppen</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Nye borgere med komplekse diagnoser eller uafklarede forløb
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Ferieafvikling og ubesatte stillinger</span>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    ...
                    alt="Professionel psykiatrisk vikar i Birkerød - støtte i pressede situationer"
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900">
              Lokalkendskab og hurtig reaktion i Birkerød og Rudersdal
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi dækker Birkerød, Holte, Vedbæk, Nærum og resten af Rudersdal Kommune. Vi har kort responstid, og vi
              tilbyder både enkeltvagter, døgnforløb og længerevarende vikarløsninger – med fast kontaktperson og
              tydelig kommunikation hele vejen.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-lg font-semibold text-gray-900">Birkerød</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Holte</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Vedbæk</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-red-50 to-rose-50 p-6 rounded-2xl border border-red-100">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Nærum</span>
                    </div>
                    <div className="flex items-center">
                      <MapPin className="w-5 h-5 text-red-600 mr-3" />
                      <span className="text-lg font-semibold text-gray-900">Rudersdal Kommune</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Vi dækker også tilstødende områder efter aftale</strong>
                </p>
              </div>
            </motion.div>
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Hvem er vores vikarer?</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Vores vikarer er nøje udvalgte og fagligt funderede personer, typisk med baggrund som:
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Social- og sundhedsassistenter</strong>
                    <p className="text-gray-700">Med erfaring fra psykiatriske botilbud og plejecentre</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Socialpædagoger</strong>
                    <p className="text-gray-700">Specialiseret i arbejdet med komplekse borgergrupper</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Pædagogiske assistenter</strong>
                    <p className="text-gray-700">Med fokus på relationel tilgang og struktur</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Når ældre og voksne har brug for mere end blot praktisk hjælp, træder vi til med vikarer, der skaber
              nærvær, struktur og respekt i en kompleks hverdag.
            </p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">
                Vores vikarer har solid erfaring med
              </h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Demens og kognitiv svækkelse</h4>
                      <p className="text-gray-700">hvor genkendelige rutiner og rolig kontakt er afgørende</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Psykiske lidelser hos voksne</h4>
                      <p className="text-gray-700">som kalder på tydelige rammer og vedholdende relationsarbejde</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Kombinerede somatiske og psykiske behov</h4>
                      <p className="text-gray-700">hvor helhedsforståelse er nødvendig</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-start mb-4">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 mb-2">Overgangs- og krisesituationer</h4>
                      <p className="text-gray-700">hvor tryghed skal genetableres hurtigt og professionelt</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100 inline-block">
                <p className="text-xl text-gray-700 leading-relaxed font-medium max-w-3xl">
                  <strong>Vi møder den enkelte med respekt for livshistorie, værdighed og dagsform</strong> – og indgår
                  loyalt i det eksisterende personale. Vores vikarer forstår balancen mellem omsorg, struktur og
                  samarbejde med både pårørende og faggrupper.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-xl font-semibold mb-8 text-gray-800">
                På børn- og ungeområdet leverer vi specialiseret vikarbemanding til bosteder, opholdssteder og
                skræddersyede tilbud, hvor relationel kontinuitet og faglig tryghed er afgørende.
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Udadreagerende eller grænseprøvende adfærd</strong> hvor tydelige voksne og faste strukturer
                    er nødvendige
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Psykiske udfordringer og udviklingsmæssige sårbarheder</strong> der kræver tålmodighed og
                    forståelse
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Skolefravær, misbrug og sociale belastninger</strong> hvor der skal bygges bro til hverdagen
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Anbringelser og familiebrud</strong> hvor tillid og forudsigelighed bliver afgørende
                    ressourcer
                  </p>
                </div>
              </div>
              <p className="text-gray-700 mt-8 text-lg leading-relaxed">
                Vores tilgang er pædagogisk og psykologisk funderet – og altid med respekt for den unges baggrund,
                grænser og potentiale.
              </p>
            </motion.div>
            ...
            >
              <div className="text-center lg:text-left">
                ...
                <div className="hidden lg:flex lg:items-center mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900">
                    Fleksible løsninger – vi tilpasser os jeres behov
                  </h2>
                </div>
                <h2 className="text-3xl font-bold text-gray-900 mb-8 lg:hidden">
                  Fleksible løsninger – vi tilpasser os jeres behov
              ...
              <p className="text-gray-700 mb-8 text-lg leading-relaxed">Vi kan tilbyde:</p>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Akut tilkald</strong> ved personalefratrædelse, sygdom eller optrapning i borgeradfærd
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Planlagte forløb</strong> fx ferieperioder, sygevikariater og barselsdækning
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Langsigtede løsninger</strong> fx ved midlertidig kapacitetsudvidelse
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <p className="text-gray-700 text-lg">
                    <strong>Fast team</strong> ved behov for kontinuitet og kendte ansigter over tid
                  </p>
                </div>
              </div>
              <p className="text-gray-700 text-lg leading-relaxed mt-8">
                Vi har fokus på <strong>samarbejde, tilpasning og kvalitet</strong> – og vi er tilgængelige alle ugens
                dage.
              </p>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 max-w-4xl mx-auto leading-tight">
              Eksempler på opgaver vi løser i Birkerød
            </h2>
          </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700 font-medium">
                      §85-støtte til borgere med behov for struktur og stabil kontakt
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">
                      Dækning af natarbejde i psykiatriske botilbud
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">
                      Akut indsættelse ved eskalering i adfærd hos borger
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">Støtte til selvskadende unge i døgntilbud</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">
                      Afløsning og tryghedsvagter på plejecentre med demente beboere
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700 font-medium">
                      Forstærkning i overgangsforløb mellem tilbud
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Tryghedspersonale.dk - Psykiatrisk vikarbureau i Birkerød - Ring 41 44 33 33"
                    fill
                    className="object-cover select-none pointer-events-none"
                    sizes="(max-width: 1024px) 100vw, 40vw"
                    draggable={false}
      ...
      <section id="kontakt" className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Kontakt os i dag</h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Er du teamleder, koordinator eller afdelingsleder i Birkerød og har brug for pålidelige vikarer med
              erfaring fra psykiatri, socialpædagogik og pleje?
            </p>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Birkerød, socialpædagogisk vikar Birkerød, vikar ved
              udadreagerende adfærd Birkerød, vikar til dobbeltdiagnoser Birkerød, selvskadende borgere vikar Birkerød,
              §85 og §108 vikar Birkerød, vikarbureau psykiatri Rudersdal Kommune
            </p>
            <p>Vi leverer kvalificeret personale, som skaber tryghed i jeres dagligdag – både på kort og lang sigt.</p>
          </div>
        </div>
      </section>
    </div>
