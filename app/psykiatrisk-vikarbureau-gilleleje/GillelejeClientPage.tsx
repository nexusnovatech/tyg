...
export default function GillelejeClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Gilleleje",
    ...
    },
    {
      ...
      alt: "Tryghedsmedarbejder der støtter ældre borger i Gilleleje",
      title: "Specialiseret i socialpsykiatri",
      subtitle:
        "Som psykiatrisk vikarbureau i Gilleleje forstår vi de særlige udfordringer, der opstår i arbejdet med borgere med psykiske lidelser, demens og udviklingsforstyrrelser. Vores vikarer har omfattende erfaring med at skabe trygge rammer og professionelle relationer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Gilleleje",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Gilleleje og hele Nordsjælland. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Gilleleje & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Gilleleje?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Psykiatrisk Vikarbureau i Gilleleje
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Tryghedspersonale.dk tilbyder professionel og specialiseret vikardækning til botilbud, plejecentre
                    og socialpsykiatriske enheder i Gilleleje og omegn. Vi leverer kvalificerede vikarer med solid
                    erfaring i at håndtere komplekse psykiatriske og demensrelaterede udfordringer, som sikrer tryghed
                    og stabilitet i både akutte og længerevarende situationer.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi ved, hvor vigtigt det er at have adgang til fagligt kompetent personale, som kan skabe ro og
                    tryghed, især i situationer med udadreagerende adfærd, demens eller andre sociale og psykiatriske
                    problemstillinger. Vores vikarer bidrager aktivt til at opretholde en stabil hverdag for både
                    borgere og fast personale.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Når behovet for ekstra støtte opstår
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Rolig og struktureret håndtering for at sikre tryghed</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Krisesituationer</strong>
                          <p className="text-gray-700 text-sm">Midlertidig støtte under forflytninger</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">Ved sygdom, ferie eller vakante stillinger</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Komplekse udfordringer</strong>
                          <p className="text-gray-700 text-sm">Specialiseret viden og indsats</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker Gilleleje og omegn</h3>
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/gilleleje-hero.png"
                        alt="Professionel psykiatrisk vikar i Gilleleje - specialiseret i komplekse borgerforløb"
                        fill
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Professionel psykiatrisk vikar i varm samtale med ældre borger - nærværende og forstående pleje i Gilleleje"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Gilleleje og omegn
            </h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center" style={{ backgroundColor: "#e9f8ee", padding: "20px", borderRadius: "5px" }}>
            <p style={{ color: "#127035", margin: "0" }}>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Gilleleje, vikardækning botilbud Gilleleje, vikar ved
              udadreagerende adfærd Gilleleje, demensvikar Gilleleje, socialpsykiatrisk vikar Gilleleje, midlertidig
              vikar Gilleleje §85 §108
            </p>
          </div>
        </div>
      </section>
