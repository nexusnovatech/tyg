  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4 bg-red-100 text-red-800 hover:bg-red-200">
                Pædagogisk Vikarbureau Vordingborg
              </Badge>
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Få pædagogisk støtte og tryghed med kvalificerede vikarer i Vordingborg
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Har din institution eller dit bosted i Vordingborg brug for erfarne pædagogiske vikarer, der kan træde
                til med det samme? Vi tilbyder kompetent personale, der er klar til at skabe et trygt og udviklende
                miljø for både borgere og fast personale.
              </p>
            ...
            <div className="relative">
              <Image
                src="/vordingborg-psychiatric-care.png"
                alt="Professionel omsorg i Vordingborg"
                width={600}
                height={400}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vi leverer vikarer til bosteder, plejehjem og institutioner, hvor vi specialiserer os i at støtte voksne
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-2 hover:border-red-200 transition-colors">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-3">Dedikerede Fagfolk</h3>
                <p className="text-gray-600">
                  Vores vikarer er ikke blot afløsere – de er dedikerede fagfolk, der er parate til at gøre en positiv
                  forskel i hverdagen.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Hvorfor vælge Tryghedspersonale.dk i Vordingborg?
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Tryghedspersonale.dk er din foretrukne partner, når du mangler kompetente og pålidelige vikarer i
                Vordingborg. Vi tilbyder skræddersyede vikarløsninger, der passer perfekt til din institutions eller dit
                bosteds specifikke behov.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Kompetente og engagerede</h4>
                    <p className="text-gray-600">Klar til at håndtere udfordrende og komplekse miljøer</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative">
              <Image
                ...
                alt="Professionel vikar i Vordingborg"
                width={500}
                height={400}
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vores vikarer kan tilbyde en række specialistkompetencer fra forskellige faglige baggrunde
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Serviceområder i Vordingborg</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Lokalt vikarbureau i Vordingborg og omegn</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Som lokalt orienteret vikarbureau har vi solid erfaring med at levere kvalificerede vikarer til
              institutioner og bosteder i Vordingborg-området
            </p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Vi kender Vordingborg-området og har erfaring med lokale institutioner og deres specifikke behov.
                </p>
              </CardContent>
            </Card>
            <Card className="text-center">
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">Vi sikrer, at din institution får den rette støtte og kontinuitet.</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Hvordan gør vores vikarer en forskel i Vordingborg?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Vi tilpasser vores støtte til den enkelte borgers unikke behov</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Kontakt os for pædagogiske vikarer i Vordingborg</h2>
              <p className="text-lg text-gray-300 mb-8">
                Har du akut eller planlagt behov for kvalificerede pædagogiske vikarer i Vordingborg? Vi står klar med
                erfarne og dedikerede vikarer, der kan understøtte både dit faste personale og dine borgere.
              </p>
              <div className="space-y-4">
