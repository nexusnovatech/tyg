...
export default function PraestoeClientPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Få pædagogisk støtte og tryghed med kvalificerede vikarer i <span className="text-red-600">Præstø</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Har din institution eller dit bosted i Præstø brug for erfarne pædagogiske vikarer, der kan træde til
                med det samme? Hos Tryghedspersonale.dk tilbyder vi kompetent personale, der er klar til at skabe et
                trygt og udviklende miljø for både borgere og fast personale.
              </p>
            ...
            <div className="relative">
              <Image
                ...
                alt="Pædagogisk støtte i Præstø"
                width={600}
                height={400}
