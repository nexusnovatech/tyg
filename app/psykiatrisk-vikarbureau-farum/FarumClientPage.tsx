...
export default function FarumClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Farum",
      title: "Specialiseret i komplekse borgerforløb",
      subtitle:
        "Vores personale er uddannet til at håndtere komplekse psykiatriske situationer i Farum og Furesø Kommune. Vi forstår udfordringerne ved psykiske lidelser, demens og udviklingsforstyrrelser, og vi skaber trygge rammer for både borgere og personale.",
    },
    {
      src: "/tryghedspersonale-aeldre-stoette.jpeg",
      alt: "Tryghedsmedarbejder der støtter ældre borger i Farum",
      title: "Professionel psykiatrisk støtte",
      subtitle:
        "Som psykiatrisk vikarbureau i Farum tilbyder vi specialiserede vikarer med omfattende erfaring inden for psykiatri, socialpædagogik og demenspleje. Vores medarbejdere er trænet i konflikthåndtering og deeskalering.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Farum",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger og socialpsykiatriske tilbud i Farum og hele Furesø Kommune. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Farum & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Farum?
              </h3>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-gray-900 leading-tight">
                Tryghedspersonale.dk – Din lokale psykiatriske vikarløsning i Farum
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Hos <strong>Tryghedspersonale.dk</strong> tilbyder vi professionelle psykiatriske og
                    socialpædagogiske vikarer, som forstår kompleksiteten i arbejdet med psykisk sårbare borgere i{" "}
                    <strong>Farum og Furesø Kommune</strong>. Vores vikarer er specialiserede i at skabe tryghed og
                    stabilitet på plejehjem, bosteder og socialpsykiatriske tilbud.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Vi har fokus på både faglighed og empati, hvilket sikrer den bedste støtte til borgere med psykiske
                    lidelser, demens og komplekse adfærdsudfordringer. Vi leverer fleksible, erfarne og robuste vikarer,
                    der kan træde til med kort varsel ved behov for ekstra hænder i pressede situationer.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <h3 className="font-bold text-2xl mb-6 text-gray-900 flex items-center">
                      ...
                      Vores kompetenceområder i Farum
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            håndtering af psykoser, personlighedsforstyrrelser, PTSD, angst m.m.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            støtte til borgere med udadreagerende eller forværrede demenssymptomer
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            støtte til børn, unge og voksne med autismespektrumforstyrrelser, ADHD og
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">
                            stabilisering ved kriser og behov for ekstra faglig støtte
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90 mb-4">Vi er klar til at hjælpe med akut bemanding i Farum</p>
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker Farum og omegn</h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Farum by</p>
                      <p>• Værløse</p>
                      <p>• Hareskovby</p>
                      <p>• Stavnsholt</p>
                      <p>• Hele Furesø Kommune</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/farum-hero.png"
                        alt="Psykiatrisk vikarbureau Farum - specialiseret i komplekse borgerforløb"
                        fill
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                eksisterende personale i Farum og Furesø Kommune.
              </p>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    ...
                    alt="Professionel psykiatrisk vikar i varm samtale med ældre borger - nærværende og forstående pleje i Farum"
                    fill
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt Tryghedspersonale.dk i Farum for professionel vikarhjælp
            </h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Har I akut behov eller ønsker I at planlægge langsigtet vikarassistance i Farum og Furesø Kommune? Vi er
              klar med hurtig og professionel bemanding.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-xl">Alle dage, inklusive weekender og helligdage</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="text-center text-sm text-gray-600 space-y-4">
            ...
            >
              <p style={{ color: "#127035" }}>
                <strong>Søgeord:</strong> psykiatrisk vikarbureau Farum, vikar psykiatri Furesø Kommune,
                socialpsykiatrisk vikarbureau Farum, akut vikar demens Farum, vikarbureau til bosted Farum, psykiatrisk
                støtte Farum by, vikar til socialpsykiatri Farum
              </p>
            </div>
            <p>Vi dækker: Farum, Værløse, Hareskovby, Stavnsholt og hele Furesø Kommune</p>
          </div>
        </div>
      </section>
    </div>
