...
export default function IshojClientPage() {
      ...
      <section className="relative bg-gradient-to-br from-red-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="bg-red-100 text-red-800 mb-4">Pædagogisk Vikarbureau Ishøj</Badge>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Din betroede partner til <span className="text-red-600">pædagogisk støtte</span> i Ishøj
              </h1>
