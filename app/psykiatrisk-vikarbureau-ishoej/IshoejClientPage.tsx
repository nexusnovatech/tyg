...
export default function IshoejClientPage() {
  ...
  const heroSlides = [
    {
      src: "/ishoej-hero.png",
      alt: "Psykiatrisk Vikarbureau Ishøj - Specialiseret i komplekse borgerforløb",
    ...
    {
      src: "/ishoej-image-1.png",
      alt: "Tryghedsmedarbejder der støtter ældre borger i Ishøj",
      title: "Specialiseret i socialpsykiatri",
      subtitle:
        "Som psykiatrisk vikarbureau i Ishøj forstår vi de særlige udfordringer, der opstår i arbejdet med borgere med psykiske lidelser, demens og udviklingsforstyrrelser. Vores vikarer har omfattende erfaring med at skabe trygge rammer og professionelle relationer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Ishøj",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger, krisecentre og asylcentre i Ishøj Kommune og hele Region Hovedstaden. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Ishøj & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Ishøj?
              </h3>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    Tryghedspersonale.dk tilbyder specialiseret og fagligt kvalificeret vikarbemanding til botilbud,
                    plejecentre, døgntilbud samt §85- og §108-forløb i Ishøj. Vi står klar med erfarne medarbejdere, der
                    sikrer stabilitet og tryghed i komplekse psykiatriske og sociale situationer, hvor det faste
                    personale har brug for ekstra støtte – både akut og over længere tid.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Der opstår ofte situationer i botilbud og plejefaciliteter, hvor borgere har behov, der overstiger
                    det faste personales kapacitet. Det kan skyldes sygdom, ferie, uforudsete hændelser eller komplekse
                    borgerforløb. I disse tilfælde træder vi til med vikarer, der bidrager til stabilitet og tryghed, så
                    borgerne får den rette støtte i sikre rammer.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <strong className="text-gray-900">
                            Aflastning af personale i socialpsykiatriske miljøer
                          </strong>
                        </div>
                      </div>
                    </div>
                ...
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90 mb-4">
                      Vi er klar til at hjælpe jer med akut og planlagt vikardækning
                    </p>
                    <a href="tel:41443333">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi dækker Ishøj og omegn</h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Ishøj Kommune</p>
                      <p>• Vallensbæk</p>
                      <p>• Brøndby</p>
                      <p>• Hvidovre</p>
                      <p>• Hele Region Hovedstaden</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Vi har indgående kendskab til rammerne og udfordringerne i Ishøj og tilbyder vikarer med relevant
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Der opstår ofte situationer i botilbud og plejefaciliteter, hvor borgere har behov, der overstiger det
                faste personales kapacitet. Det kan skyldes sygdom, ferie, uforudsete hændelser eller komplekse
                borgerforløb.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                Vi har indgående kendskab til rammerne og udfordringerne i Ishøj og tilbyder vikarer med relevant
                uddannelse og praktisk erfaring inden for social- og sundhedsområdet. Vores medarbejdere arbejder med
                respekt for borgernes individuelle behov og de pædagogiske principper.
              </p>
              ...
              <div className="bg-gradient-to-r from-red-50 to-rose-50 p-8 rounded-2xl border border-red-100">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="text-lg text-gray-700">Akut optrapning i en borgers adfærd</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Personalemangel ved sygdom eller fravær</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Forflytningssager, der kræver ekstra ressourcer</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Uro eller konflikter i beboergrupper</span>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Kontakt os – Vi er klar til at hjælpe i Ishøj og omegn
            </h2>
      ...
      <section className="py-16 bg-green-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <p>
              <strong>Søgeord:</strong> psykiatrisk vikarbureau Ishøj, vikar psykiatri Ishøj, demensvikar Ishøj,
              socialpsykiatrisk vikar Ishøj, vikardækning botilbud Ishøj, vikar §85 Ishøj
            </p>
            <p>Vi dækker: Ishøj Kommune, Vallensbæk, Brøndby, Hvidovre og øvrige dele af Region Hovedstaden</p>
          </div>
        </div>
      </section>
    </div>
