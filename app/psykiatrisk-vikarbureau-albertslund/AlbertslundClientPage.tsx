...
import { Phone, Mail, Heart, Clock, Shield } from "lucide-react"
...
export default function AlbertslundClientPage() {
  ...
  const heroSlides = [
    {
      ...
      alt: "Tryghedsmedarbejder i samtale med borger i Albertslund",
      title: "Eksperter i udadreagerende adfærd",
      subtitle:
        "Tryghedspersonale.dk tilbyder specialiseret og fagligt kvalificeret vikarbemanding til botilbud, døgntilbud, plejecentre og §85-/§108-forløb i Albertslund. Vi leverer erfarne medarbejdere, der sikrer tryghed og stabilitet i komplekse pleje- og socialpsykiatriske situationer.",
    },
    {
      src: "/tryghedspersonale-aeldre-stoette.jpeg",
      alt: "Tryghedsmedarbejder der støtter ældre borger i Albertslund",
      title: "Specialiseret i socialpsykiatri",
      subtitle:
        "Vi fokuserer særligt på udadreagerende og udfordrende adfærd, demensrelaterede problemstillinger, midlertidig støtte ved kriser og forflytninger, samt aflastning af personale i socialpsykiatriske og plejefaglige miljøer.",
    },
    {
      src: "/tryghedspersonale-park-samtale.jpeg",
      alt: "Tryghedsmedarbejder i samtale med borger i park i Albertslund",
      title: "Akut hjælp når I har brug for det",
      subtitle:
        "Vi tilbyder både akut udrykning og planlagte vikarløsninger til plejehjem, botilbud, psykiatriske afdelinger og specialiserede tilbud i Albertslund. Vores mål er at være jeres pålidelige partner.",
    },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <EnhancedHeroSlider slides={heroSlides} locationLabel="Albertslund & omegn" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              <h3 className="text-white text-xl md:text-2xl font-semibold">
                Søger du efter et psykiatrisk Vikarbureau i Albertslund?
              </h3>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-2">
                <div className="prose prose-xl max-w-none">
                  ...
                  >
                    I mange tilfælde opstår der situationer, hvor borgere i botilbud eller plejefaciliteter i
                    Albertslund har behov, som overstiger det faste personales kapacitet. Det kan skyldes sygdom, ferie,
                    uforudsete hændelser eller komplekse borgerforløb.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Her træder vi til med vikarer, der både kan skabe stabilitet og sikre, at borgerne får den rette
                    støtte i trygge rammer.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <strong className="text-gray-900">En borgers akutte forværring</strong>
                          <p className="text-gray-700 text-sm">eller uforudsigelige adfærd</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                        <div>
                          ...
                          <p className="text-gray-700 text-sm">ved sygdom eller andre fravær</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Forflytningssager</strong>
                          <p className="text-gray-700 text-sm">der tager tid at gennemføre</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                        <div>
                          <strong className="text-gray-900">Uro eller konflikter</strong>
                          <p className="text-gray-700 text-sm">i beboergrupper</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90 mb-4">Vi står klar til at hjælpe</p>
                    <a href="tel:41443333">
                  ...
                  >
                    <h3 className="font-bold text-lg mb-4 text-gray-900">Vi fokuserer på</h3>
                    <div className="space-y-2 text-sm text-gray-700">
                      <p>• Udadreagerende og udfordrende adfærd</p>
                      <p>• Demensrelaterede problemstillinger</p>
                      <p>• Midlertidig støtte ved kriser</p>
                      <p>• Aflastning af personale</p>
                      <p>• Sikring af ro og struktur</p>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: 20 }}
                  ...
                  >
                    <div className="aspect-[3/4]">
                      <Image
                        src="/tryghedspersonale-aeldre-stoette.jpeg"
                        alt="Professionel psykiatrisk vikar i Albertslund"
                        fill
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <strong className="text-gray-900 text-lg">Pædagoger og social- og sundhedsassistenter</strong>
                    <p className="text-gray-700">eller har tilsvarende praksiserfaring</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Viden om konflikthåndtering</strong>
                    <p className="text-gray-700">low arousal og relationsarbejde</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Understøtter det eksisterende team</strong>
                    <p className="text-gray-700">med respekt for etablerede rutiner</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <strong className="text-gray-900 text-lg">Dokumenterer og samarbejder tværfagligt</strong>
                    <p className="text-gray-700">med fokus på kvalitet</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-[4/5]">
                <Image
                  src="/tryghedspersonale-samtale-udendoers.jpeg"
                  alt="Professionel psykiatrisk vikar i samtale med borger i Albertslund"
                  fill
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[2/3]">
                  <Image
                    src="/albertslund-image-1.png"
                    alt="Professionel psykiatrisk vikar i varm samtale med ældre borger i Albertslund - nærværende og forstående pleje"
                    fill
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            >
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                Vi ved, at hver opgave er unik. Derfor tilbyder vi en fleksibel og tillidsfuld tilgang med muligheder
                for:
              </p>
              <div className="bg-gradient-to-r from-red-50 to rose-50 p-8 rounded-2xl border border-red-100">
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Akut indsats ved uventede personalebehov</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">Planlagt vikardækning i ferier eller ved kendt fravær</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Længerevarende forløb i tilfælde af sygdom eller ledige stillinger
                    </span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                    <span className="text-lg text-gray-700">
                      Faglig sparring og dialog med ledelsen for at sikre sammenhængende indsats
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5]">
                  <Image
                    src="/albertslund-image-2.png"
                    alt="Psykiatrisk Vikarbureau Albertslund - Professionel håndtering af udadreagerende, voldsomme og psykotiske borgere"
                    fill
                    className="object-cover select-none pointer-events-none"
                    sizes="(max-width: 1024px) 100vw, 40vw"
                    draggable={false}
      ...
      <section id="kontakt" className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Kontakt os – vi hjælper i Albertslund</h2>
            <p className="text-xl md:text-2xl mb-16 opacity-90 max-w-4xl mx-auto">
              Har du ansvar for et tilbud eller en enhed i Albertslund, hvor behovet overstiger de faste ressourcer? Vi
              står klar til at bistå med både akut og planlagt vikarbemanding.
            </p>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center text-sm text-gray-600 space-y-4">
            <div
              ...
              style={{ backgroundColor: "#e9f8ee", borderRadius: "5px" }}
            >
              <p style={{ color: "#127035" }}>
                <strong>Søgeord:</strong> psykiatrisk vikarbureau Albertslund, vikar psykiatri Albertslund, demensvikar
                Albertslund, socialpsykiatrisk vikar Albertslund, vikardækning botilbud Albertslund, vikar §85
                Albertslund
              </p>
            </div>
            <p>
              Vi sikrer en stabil, tryg og fagligt velkvalificeret indsats, som skaber ro for både borgere og personale
              i Albertslund og omegn.
            </p>
          </div>
        </div>
      </section>
